...
public class EntityRainsplodeFX extends EntityFX
{
    ...
    public EntityRainsplodeFX(TextureManager par1TextureManager, World par2World, double par3, double par5, double par7, double par9, double par11, double par13)
    {
    ...
    private void newRandomColour() {
		Color col = Color.getHSBColor(rand.nextFloat(),1.0F,0.5F);
