...
import yam.gen.classic.GenTreeClassic;
...
import yam.items.ItemThemedSpawnEgg;
...
public class YetAnotherMod
{
    ...
    public static Block lightNetherrack;
    public static Block lightSoulsand;
    public static Block lightGlowstone;
    public static Block lightEndstone;
    ...
    public static Block lightClay;
    public static Block lightMushroomCap;
    public static Block lightMushroomStem;
    public static Block lightWool;
    public static Block wishstoneOre;
    public static Block hopestoneOre;
    public static Block hopestoneNetherOre;
    ...
    public void init(FMLInitializationEvent event)
    {
    	...
    	lightShard = new ItemGeneric("aura/light/shard").setUnlocalizedName("lightShard");
    	GameRegistry.registerItem(lightShard, "lightShard");
    	lightDirt = new BlockGeneric(Material.ground, "aura/light/dirt").setLightOpacity(255).setHardness(0.4F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightDirt");
    	lightDirt.setHarvestLevel("shovel", 0);
    	lightDirt.slipperiness = 1.01F;
    	((BlockGeneric)lightDirt).setAura(1);
    	((BlockGeneric)lightDirt).setDrops(YetAnotherMod.lightShard, 1, 1);
    	GameRegistry.registerBlock(lightDirt, "lightDirt");
    	lightGrass = new BlockCustomGrass("aura/light/grass/top", "aura/light/grass/side", "aura/light/dirt", YetAnotherMod.lightDirt).setLightOpacity(255).setHardness(0.5F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightGrass");
    	lightGrass.setHarvestLevel("shovel", 0);
    	lightGrass.slipperiness = 1.01F;
    	((BlockGeneric)lightGrass).setAura(1);
    	((BlockGeneric)lightGrass).setDrops(YetAnotherMod.lightShard, 1, 1);
    	GameRegistry.registerBlock(lightGrass, "lightGrass");
    	lightStone = new BlockGeneric(Material.rock, "aura/light/stone").setLightOpacity(255).setHardness(1.2F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightStone");
    	lightStone.setHarvestLevel("pickaxe", 0);
    	lightStone.slipperiness = 1.01F;
    	((BlockGeneric)lightStone).setAura(1);
    	((BlockGeneric)lightStone).setDrops(YetAnotherMod.lightShard, 1, 1);
    	GameRegistry.registerBlock(lightStone, "lightStone");
    	lightBricks = new BlockGeneric(Material.rock, "aura/light/bricks").setLightLevel(1F).setLightOpacity(255).setHardness(1.2F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightBricks");
    	lightBricks.setHarvestLevel("pickaxe", 0);
    	lightBricks.slipperiness = 1.01F;
    	((BlockGeneric)lightBricks).setAura(1);
    	((BlockGeneric)lightBricks).setDrops(YetAnotherMod.lightShard, 1, 2);
    	GameRegistry.registerBlock(lightBricks, "lightBricks");
    	lightCobblestone = new BlockGeneric(Material.rock, "aura/light/cobblestone").setLightLevel(1F).setLightOpacity(255).setHardness(1.2F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightCobblestone");
    	lightCobblestone.setHarvestLevel("pickaxe", 0);
    	lightCobblestone.slipperiness = 1.01F;
    	((BlockGeneric)lightCobblestone).setAura(1);
    	((BlockGeneric)lightCobblestone).setDrops(YetAnotherMod.lightShard, 1, 1);
    	GameRegistry.registerBlock(lightCobblestone, "lightCobblestone");
    	lightPolishedStone = new BlockGeneric(Material.rock, "aura/light/polished").setLightLevel(1F).setLightOpacity(255).setHardness(1.6F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightPolishedStone");
    	...
    	((BlockGeneric)lightPolishedStone).setDrops(YetAnotherMod.lightShard, 1, 3);
    	GameRegistry.registerBlock(lightPolishedStone, "lightPolishedStone");
    	lightMossyCobblestone = new BlockGeneric(Material.rock, "aura/light/mossstone").setLightLevel(1F).setLightOpacity(255).setHardness(1.2F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightMossyCobblestone");
    	...
    	((BlockGeneric)lightMossyCobblestone).setDrops(YetAnotherMod.lightShard, 1, 3);
    	GameRegistry.registerBlock(lightMossyCobblestone, "lightMossyCobblestone");
    	lightSandstone = new BlockGeneric(Material.rock, "aura/light/sandstone").setLightOpacity(255).setHardness(1.3F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightSandstone");
    	lightSandstone.setHarvestLevel("pickaxe", 0);
    	lightSandstone.slipperiness = 1.01F;
    	((BlockGeneric)lightSandstone).setAura(1);
    	((BlockGeneric)lightSandstone).setDrops(YetAnotherMod.lightShard, 1, 2);
    	GameRegistry.registerBlock(lightSandstone, "lightSandstone");
    	lightNetherrack = new BlockGeneric(Material.rock, "aura/light/netherrack").setLightOpacity(255).setHardness(1.3F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightNetherrack");
    	lightNetherrack.setHarvestLevel("pickaxe", 0);
    	lightNetherrack.slipperiness = 1.01F;
    	((BlockGeneric)lightNetherrack).setAura(1);
    	((BlockGeneric)lightNetherrack).setDrops(YetAnotherMod.lightShard, 1, 2);
    	GameRegistry.registerBlock(lightNetherrack, "lightNetherrack");
    	lightSoulsand = new BlockGeneric(Material.rock, "aura/light/soulsand").setLightOpacity(255).setHardness(1.3F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightSoulsand");
    	lightSoulsand.setHarvestLevel("shovel", 0);
    	lightSoulsand.slipperiness = 1.01F;
    	((BlockGeneric)lightSoulsand).setAura(1);
    	((BlockGeneric)lightSoulsand).setDrops(YetAnotherMod.lightShard, 1, 2);
    	GameRegistry.registerBlock(lightSoulsand, "lightSoulsand");
    	lightGlowstone = new BlockGeneric(Material.rock, "aura/light/glowstone").setLightOpacity(255).setHardness(1.3F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightGlowstone");
    	lightGlowstone.setHarvestLevel("shovel", 0);
    	lightGlowstone.slipperiness = 1.01F;
    	((BlockGeneric)lightGlowstone).setAura(1);
    	((BlockGeneric)lightGlowstone).setDrops(YetAnotherMod.lightShard, 1, 4);
    	GameRegistry.registerBlock(lightGlowstone, "lightGlowstone");
    	lightEndstone = new BlockGeneric(Material.rock, "aura/light/endstone").setLightOpacity(255).setHardness(0.8F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightEndstone");
    	lightEndstone.setHarvestLevel("pickaxe", 0);
    	lightEndstone.slipperiness = 1.01F;
    	((BlockGeneric)lightEndstone).setAura(1);
    	((BlockGeneric)lightEndstone).setDrops(YetAnotherMod.lightShard, 1, 3);
    	GameRegistry.registerBlock(lightEndstone, "lightEndstone");
    	lightSand = new BlockGeneric(Material.ground, "aura/light/sand").setLightOpacity(255).setHardness(0.3F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightSand");
    	lightSand.setHarvestLevel("shovel", 0);
    	lightSand.slipperiness = 1.01F;
    	((BlockGeneric)lightSand).setAura(1);
    	((BlockGeneric)lightSand).setDrops(YetAnotherMod.lightShard, 1, 2);
    	((BlockGeneric)lightSand).setGravity(true);
    	GameRegistry.registerBlock(lightSand, "lightSand");
    	lightGravel = new BlockGeneric(Material.ground, "aura/light/gravel").setLightOpacity(255).setHardness(0.5F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightGravel");
    	lightGravel.setHarvestLevel("shovel", 0);
    	lightGravel.slipperiness = 1.01F;
    	((BlockGeneric)lightGravel).setAura(1);
    	((BlockGeneric)lightGravel).setDrops(YetAnotherMod.lightShard, 1, 2);
    	((BlockGeneric)lightGravel).setGravity(true);
    	GameRegistry.registerBlock(lightGravel, "lightGravel");
    	lightWood = new BlockGeneric(Material.wood, "aura/light/tree/wood").setLightLevel(1F).setLightOpacity(255).setHardness(0.9F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightWood");
    	lightWood.setHarvestLevel("axe", 0);
    	lightWood.slipperiness = 1.01F;
    	((BlockGeneric)lightWood).setAura(1);
    	((BlockGeneric)lightWood).setDrops(YetAnotherMod.lightShard, 1, 4);
    	GameRegistry.registerBlock(lightWood, "lightWood");
    	lightPlanks = new BlockGeneric(Material.wood, "aura/light/planks").setLightLevel(1F).setLightOpacity(255).setHardness(0.7F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightPlanks");
    	lightPlanks.setHarvestLevel("axe", 0);
    	lightPlanks.slipperiness = 1.01F;
    	((BlockGeneric)lightPlanks).setAura(1);
    	((BlockGeneric)lightPlanks).setDrops(YetAnotherMod.lightShard, 1, 1);
    	GameRegistry.registerBlock(lightPlanks, "lightPlanks");
    	lightSapling = new BlockCustomSapling("aura/light/sapling", new Block[]{lightGrass, lightDirt, Blocks.grass, Blocks.dirt}, new GenLightTree(), false).setLightLevel(1F).setLightOpacity(255).setHardness(0.0F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightSapling");
    	lightSapling.slipperiness = 1.01F;
    	((BlockGeneric)lightSapling).setAura(1);
    	((BlockGeneric)lightSapling).setDrops(YetAnotherMod.lightShard, 1, 1);
    	...
    	((BlockGeneric)lightLeaves).setDrops(YetAnotherMod.lightShard, 1, 3);
    	GameRegistry.registerBlock(lightLeaves, "lightLeaves");
    	lightGlass = new BlockGeneric(Material.glass, "aura/light/glass").setLightLevel(1F).setLightOpacity(0).setHardness(1.2F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightGlass");
    	lightGlass.slipperiness = 1.01F;
    	((BlockGeneric)lightGlass).setRenderType(0, false);
    	((BlockGeneric)lightGlass).setTransparency();
    	((BlockGeneric)lightGlass).setAura(1);
    	((BlockGeneric)lightGlass).setDrops(YetAnotherMod.lightShard, 1, 5);
    	GameRegistry.registerBlock(lightGlass, "lightGlass");
    	lightClay = new BlockGeneric(Material.ground, "aura/light/clay").setLightLevel(1F).setLightOpacity(255).setHardness(0.3F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightClay");
    	lightClay.setHarvestLevel("shovel", 0);
    	lightClay.slipperiness = 1.01F;
    	((BlockGeneric)lightClay).setAura(1);
    	((BlockGeneric)lightClay).setDrops(YetAnotherMod.lightShard, 1, 2);
    	GameRegistry.registerBlock(lightClay, "lightClay");
    	lightMushroomCap = new BlockGeneric(Material.ground, "aura/light/mushroom").setLightLevel(1F).setLightOpacity(255).setHardness(0.1F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightMushroomCap");
    	lightMushroomCap.setHarvestLevel("axe", 0);
    	lightMushroomCap.slipperiness = 1.01F;
    	((BlockGeneric)lightMushroomCap).setAura(1);
    	((BlockGeneric)lightMushroomCap).setDrops(YetAnotherMod.lightShard, 1, 4);
    	GameRegistry.registerBlock(lightMushroomCap, "lightMushroomCap");
    	lightMushroomStem = new BlockGeneric(Material.ground, "aura/light/mushroomstem", "aura/light/mushroomstem", "aura/light/mushroomtop", "aura/light/mushroomtop").setLightLevel(1F).setLightOpacity(255).setHardness(0.1F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightMushroomStem");
    	lightMushroomStem.setHarvestLevel("axe", 0);
    	lightMushroomStem.slipperiness = 1.01F;
    	((BlockGeneric)lightMushroomStem).setAura(1);
    	((BlockGeneric)lightMushroomStem).setDrops(YetAnotherMod.lightShard, 1, 3);
    	GameRegistry.registerBlock(lightMushroomStem, "lightMushroomStem");
    	lightWool = new BlockGeneric(Material.ground, "aura/light/wool").setLightLevel(1F).setLightOpacity(255).setHardness(0.5F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightWool");
    	lightWool.slipperiness = 1.01F;
    	((BlockGeneric)lightWool).setAura(1);
    	((BlockGeneric)lightWool).setDrops(YetAnotherMod.lightShard, 1, 3);
    	GameRegistry.registerBlock(lightWool, "lightWool");
    	wishstoneOre = new BlockGeneric(Material.rock, "ores/wishstone").setLightLevel(1F).setLightOpacity(255).setHardness(2.4F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("wishstoneOre");
    	...
    	hopestoneOre = new BlockGeneric(Material.rock, "ores/hopestone").setLightLevel(1F).setLightOpacity(255).setHardness(3.4F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("hopestoneOre");
    	...
    	hopestoneNetherOre = new BlockGeneric(Material.rock, "ores/hopestone2").setLightLevel(1F).setLightOpacity(255).setHardness(3.4F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("hopestoneNetherOre");
    	hopestoneNetherOre.setHarvestLevel("pickaxe", 0);
    	hopestoneNetherOre.slipperiness = 1.01F;
    	((BlockGeneric)hopestoneNetherOre).setAura(1);
    	((BlockGeneric)hopestoneNetherOre).setDrops(null, 1, 1);
    	GameRegistry.registerBlock(hopestoneNetherOre, "hopestoneNetherOre");
    	dreamstoneOre = new BlockGeneric(Material.rock, "ores/dreamstone").setLightLevel(1F).setLightOpacity(255).setHardness(3.4F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("dreamstoneOre");
    	...
    	((BlockGeneric)bloodwood).setGravity(true);
    	...
    	nostalgiaSapling = new BlockCustomSapling("nostalgia/sapling", new Block[]{nostalgiaGrass, Blocks.grass, Blocks.dirt}, new GenTreeClassic(), true).setBlockName("nostalgiaSapling");
    	...
    	psychopigSpawnEgg = new ItemThemedSpawnEgg("wasteland", psychoPig, 15771042, 0).setUnlocalizedName("psychopigSpawnEgg");
    	GameRegistry.registerItem(psychopigSpawnEgg, "psychopigSpawnEgg");
    	flySpawnEgg = new ItemThemedSpawnEgg("wasteland", fly, Integer.parseInt("333333", 16), Integer.parseInt("000000", 16)).setUnlocalizedName("flySpawnEgg");
    	GameRegistry.registerItem(flySpawnEgg, "flySpawnEgg");
    	derekJrSpawnEgg = new ItemThemedSpawnEgg("wasteland", derekJr, Integer.parseInt("EBC6AB", 16), Integer.parseInt("802525", 16)).setUnlocalizedName("derekJrSpawnEgg");
    	GameRegistry.registerItem(derekJrSpawnEgg, "derekJrSpawnEgg");
    	tickSpawnEgg = new ItemThemedSpawnEgg("wasteland", tick, Integer.parseInt("EBC6AB", 16), Integer.parseInt("808080", 16)).setUnlocalizedName("tickSpawnEgg");
    	GameRegistry.registerItem(tickSpawnEgg, "tickSpawnEgg");
    	theRottingSpawnEgg = new ItemThemedSpawnEgg("wasteland", theRotting, Integer.parseInt("837D55", 16), Integer.parseInt("800303", 16)).setUnlocalizedName("theRottingSpawnEgg");
    	GameRegistry.registerItem(theRottingSpawnEgg, "theRottingSpawnEgg");
    	hiddenReptileSpawnEgg = new ItemThemedSpawnEgg("wasteland", hiddenReptile, Integer.parseInt("ADAD85", 16), Integer.parseInt("558000", 16)).setUnlocalizedName("hiddenReptileSpawnEgg");
    	GameRegistry.registerItem(hiddenReptileSpawnEgg, "hiddenReptileSpawnEgg");
    	
    	lollipopperSpawnEgg = new ItemThemedSpawnEgg("rainbow", lollipopper, Integer.parseInt("FFFFFF", 16), Integer.parseInt("FFFFFF", 16)).setUnlocalizedName("lollipopperSpawnEgg");
    	GameRegistry.registerItem(lollipopperSpawnEgg, "lollipopperSpawnEgg");
    	rainbotSpawnEgg = new ItemThemedSpawnEgg("rainbow", rainbot, Integer.parseInt("FFFFFF", 16), Integer.parseInt("666666", 16)).setUnlocalizedName("rainbotSpawnEgg");
    	GameRegistry.registerItem(rainbotSpawnEgg, "rainbotSpawnEgg");
    	amplislimeSpawnEgg = new ItemThemedSpawnEgg("rainbow", amplislime, Integer.parseInt("FFFFFF", 16), Integer.parseInt("FF9922", 16)).setUnlocalizedName("amplislimeSpawnEgg");
    	GameRegistry.registerItem(amplislimeSpawnEgg, "amplislimeSpawnEgg");
    	unicornSpawnEgg = new ItemThemedSpawnEgg("rainbow", unicorn, Integer.parseInt("FFFFFF", 16), Integer.parseInt("CCBBEE", 16)).setUnlocalizedName("unicornSpawnEgg");
    	GameRegistry.registerItem(unicornSpawnEgg, "unicornSpawnEgg");
    	sparklingDragonSpawnEgg = new ItemThemedSpawnEgg("rainbow", sparklingDragon, Integer.parseInt("FFFFFF", 16), Integer.parseInt("8904B1", 16)).setUnlocalizedName("sparklingDragonSpawnEgg");
    	...
    	BiomeManager.desertBiomes.add(new BiomeEntry(biomeWasteland, 100));
    	...
    	BiomeManager.coolBiomes.add(new BiomeEntry(biomeLightAura, 100));
    	BiomeManager.warmBiomes.add(new BiomeEntry(biomeLightAura, 100));
