...
class ModelProvider<T>(val idh: IdentifierHelper<T>) {
    ...
    fun particle(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.PARTICLE.upload(i(t) ?: loc(t), Texture.particle(tx), d.modelStates::addModel) }
    ...
    fun cubeBottomTop(texture: (entry: T) -> Identifier? = { null }, textureTop: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureBottom: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CUBE_BOTTOM_TOP.upload(i(t) ?: loc(t), Texture().put(TextureKey.TOP, textureTop(t) ?: tx.suffix("top")).put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.BOTTOM, textureBottom(t) ?: tx.suffix("bottom")), d.modelStates::addModel) }
    ...
    fun orientable(texture: (entry: T) -> Identifier? = { null }, textureTop: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureFront: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.ORIENTABLE.upload(i(t) ?: loc(t), Texture().put(TextureKey.TOP, textureTop(t) ?: tx.suffix("top")).put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.FRONT, textureFront(t) ?: tx.suffix("front")), d.modelStates::addModel) }
    ...
    fun orientableVertical(texture: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureFront: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.ORIENTABLE_VERTICAL.upload(i(t) ?: loc(t), Texture().put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.FRONT, textureFront(t) ?: tx.suffix("front")), d.modelStates::addModel) }

    fun pillar(texture: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureEnd: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CUBE_COLUMN.upload(i(t) ?: loc(t), Texture().put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.END, textureEnd(t) ?: tx.suffix("end")), d.modelStates::addModel) }
    ...
    fun pillarHorizontal(texture: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureEnd: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CUBE_COLUMN_HORIZONTAL.upload(i(t) ?: loc(t), Texture().put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.END, textureEnd(t) ?: tx.suffix("end")), d.modelStates::addModel) }

    fun cross(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CROSS.upload(i(t) ?: loc(t), Texture.cross(tx), d.modelStates::addModel) }

    fun pottedCross(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.FLOWER_POT_CROSS.upload(i(t) ?: loc(t), Texture.plant(tx), d.modelStates::addModel) }

    fun generated(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.GENERATED.upload(i(t) ?: loc(t), Texture.layer0(tx), d.modelStates::addModel) }

    fun handheld(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.HANDHELD.upload(i(t) ?: loc(t), Texture.layer0(tx), d.modelStates::addModel) }

    fun parent(parent: Identifier) =
        ModelFactory<T> { d, t, i -> (i(t) ?: loc(t)).also { d.modelStates.addModel(it, SimpleModelSupplier(parent)) } }
