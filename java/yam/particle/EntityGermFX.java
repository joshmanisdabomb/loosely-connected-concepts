...
public class EntityGermFX extends EntityFX {

    private static final ResourceLocation texture = new ResourceLocation(YetAnotherMod.MODID, "textures/particle/germ.png");
	private Random rand = new Random();
	private float initialParticleScale;
    
	public EntityGermFX(World par1World, double x, double y, double z) {
	...
	public EntityGermFX(World par1World, double x, double y, double z, double speedX, double speedY, double speedZ) {
    ...
    public EntityGermFX setMaxAge(int maxAge) {
    	particleMaxAge = maxAge;
    	return this;
    }

    public EntityGermFX setGravity(float gravity) {
    	particleGravity = gravity;
    	return this;
    }
    
    public EntityGermFX setScale(float scale) {
    	particleScale = scale;
