...
public class LangData extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addAll(this::addItem, block -> mover(basic(block), 0, "dark", "milk", "white", "pink").replace("Pink", "Ruby"), LCCItems.chocolate_dark, LCCItems.chocolate_milk, LCCItems.chocolate_white, LCCItems.chocolate_pink);
