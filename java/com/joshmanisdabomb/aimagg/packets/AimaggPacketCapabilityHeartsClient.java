...
public class AimaggPacketCapabilityHeartsClient implements IMessage {
	...
	public AimaggPacketCapabilityHeartsClient() {}
	...
	public static class Handler implements IMessageHandler<AimaggPacketCapabilityHeartsClient, IMessage> {
        @Override
        public IMessage onMessage(final AimaggPacketCapabilityHeartsClient message, final MessageContext ctx) {
        ...
        private void handle(AimaggPacketCapabilityHeartsClient message, MessageContext ctx) {
