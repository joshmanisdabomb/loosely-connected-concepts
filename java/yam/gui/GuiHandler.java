...
public class GuiHandler implements IGuiHandler {
	...
	public static final int computerStorage = 6;
	public static final int drive = 7;
	public static final int pad = 8;
	
	public static void setSubGUIID(int id) {
		GuiHandler.subGUIID = id;
	}
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        } else if (tileEntity instanceof TileEntityComputer && ID == computerStorage) {
            return new ContainerComputerStorage(player.inventory, (TileEntityComputer) tileEntity, GuiHandler.subGUIID);
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (tileEntity instanceof TileEntityTrashCan) {
        	...
        	return new GuiComputerStorage(player.inventory, (TileEntityComputer) tileEntity, GuiHandler.subGUIID);
		} else if (tileEntity instanceof TileEntityComputer) {
