...
public class AimaggTEClassicChest extends TileEntity implements IInventory {
	...
	public String getBaseName() {
		return this.isDoubleChest() ? "container.chestDouble" : "container.chest";
	}
	...
	public AimaggTEClassicChest getNeighbour() {
		for (EnumFacing f : EnumFacing.HORIZONTALS) {
			TileEntity te = this.getWorld().getTileEntity(this.getPos().offset(f));
			if (te instanceof AimaggTEClassicChest) {
				return (AimaggTEClassicChest)te;
			}
		}
		return null;
	}
