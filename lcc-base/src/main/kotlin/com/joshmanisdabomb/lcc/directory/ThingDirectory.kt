...
abstract class ThingDirectory<V, P> {
    ...
    inner class ThingMapDelegate<K, R : V> internal constructor(private val keys: Array<K>, private val keyToString: (name: String, key: K) -> String = Companion::defaultKeyStringMap, private val supplier: (key: K, name: String, properties: P) -> R, propertySupplier: (key: K) -> P = { getDefaultProperty() }) : ThingDelegate<R, Map<K, R>>() {
