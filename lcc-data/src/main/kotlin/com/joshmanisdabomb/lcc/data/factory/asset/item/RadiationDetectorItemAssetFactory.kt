...
object RadiationDetectorItemAssetFactory : ItemAssetFactory {
    ...
    "overrides": [
        ...
        alts.forEach { LCCModelTemplates.template_radiation_detector.upload(it, Texture().put(LCCModelTextureKeys.t0, loc(entry)).put(LCCModelTextureKeys.t1, it), data.modelStates::addModel) }
    }
