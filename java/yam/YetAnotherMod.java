...
public class YetAnotherMod
{
    ...
    public void init(FMLInitializationEvent event)
    {
    	...
    	lightBricks = new BlockGeneric(Material.rock, "aura/light/purebricks").setLightLevel(1F).setLightOpacity(255).setHardness(1.2F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightBricks");
    	lightBricks.setHarvestLevel("pickaxe", 0);
    	lightBricks.slipperiness = 1.01F;
    	((BlockGeneric)lightBricks).setAura(1);
    	((BlockGeneric)lightBricks).setDrops(YetAnotherMod.lightShard, 1, 1);
    	...
    	((BlockGeneric)lightPolishedStone).setDrops(YetAnotherMod.lightShard, 1, 1);
    	...
    	((BlockGeneric)lightMossyCobblestone).setDrops(YetAnotherMod.lightShard, 1, 1);
    	...
    	((BlockGeneric)lightSand).setDrops(YetAnotherMod.lightShard, 1, 1);
    	...
    	((BlockGeneric)lightGravel).setDrops(YetAnotherMod.lightShard, 1, 1);
    	((BlockGeneric)lightGravel).setGravity(true);
    	GameRegistry.registerBlock(lightGravel, "lightGravel");
    	lightWood = new BlockGeneric(Material.wood, "aura/light/tree/starwood").setLightLevel(1F).setLightOpacity(255).setHardness(0.9F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightWood");
    	lightWood.setHarvestLevel("axe", 0);
    	lightWood.slipperiness = 1.01F;
    	((BlockGeneric)lightWood).setAura(1);
    	((BlockGeneric)lightWood).setDrops(YetAnotherMod.lightShard, 1, 1);
    	...
    	lightSapling = new BlockCustomSapling("aura/light/starsapling", new Block[]{lightGrass, lightDirt, Blocks.grass, Blocks.dirt}, new GenLightTree(), false).setLightLevel(1F).setLightOpacity(255).setHardness(0.0F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightSapling");
    	...
    	((BlockGeneric)lightLeaves).setDrops(YetAnotherMod.lightShard, 1, 1);
