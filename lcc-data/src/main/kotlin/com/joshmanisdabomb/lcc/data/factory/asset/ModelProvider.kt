...
class ModelProvider<T>(val idh: IdentifierHelper<T>) {
    ...
    fun particle(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.PARTICLE.upload(i(t) ?: loc(t), TextureMap.particle(tx), d.models) }
    ...
    fun cubeBottomTop(texture: (entry: T) -> Identifier? = { null }, textureTop: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureBottom: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CUBE_BOTTOM_TOP.upload(i(t) ?: loc(t), TextureMap().put(TextureKey.TOP, textureTop(t) ?: tx.suffix("top")).put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.BOTTOM, textureBottom(t) ?: tx.suffix("bottom")), d.models) }
    ...
    fun orientable(texture: (entry: T) -> Identifier? = { null }, textureTop: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureFront: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.ORIENTABLE.upload(i(t) ?: loc(t), TextureMap().put(TextureKey.TOP, textureTop(t) ?: tx.suffix("top")).put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.FRONT, textureFront(t) ?: tx.suffix("front")), d.models) }
    ...
    fun orientableVertical(texture: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureFront: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.ORIENTABLE_VERTICAL.upload(i(t) ?: loc(t), TextureMap().put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.FRONT, textureFront(t) ?: tx.suffix("front")), d.models) }

    fun pillar(texture: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureEnd: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CUBE_COLUMN.upload(i(t) ?: loc(t), TextureMap().put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.END, textureEnd(t) ?: tx.suffix("end")), d.models) }
    ...
    fun pillarHorizontal(texture: (entry: T) -> Identifier? = { null }, textureSide: (entry: T) -> Identifier? = { null }, textureEnd: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CUBE_COLUMN_HORIZONTAL.upload(i(t) ?: loc(t), TextureMap().put(TextureKey.SIDE, textureSide(t) ?: tx.suffix("side")).put(TextureKey.END, textureEnd(t) ?: tx.suffix("end")), d.models) }

    fun cross(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.CROSS.upload(i(t) ?: loc(t), TextureMap.cross(tx), d.models) }

    fun pottedCross(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.FLOWER_POT_CROSS.upload(i(t) ?: loc(t), TextureMap.plant(tx), d.models) }

    fun generated(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.GENERATED.upload(i(t) ?: loc(t), TextureMap.layer0(tx), d.models) }

    fun handheld(texture: (entry: T) -> Identifier? = { null }) =
        ModelFactory<T> { d, t, i -> val tx = texture(t) ?: loc(t); Models.HANDHELD.upload(i(t) ?: loc(t), TextureMap.layer0(tx), d.models) }
