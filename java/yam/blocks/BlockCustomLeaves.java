...
public class BlockCustomLeaves extends BlockGeneric implements IShearable {

    int[] field_150128_a;
	private String texture;
	private IIcon iFast;
	private IIcon iFancy;
    ...
    public boolean shouldSideBeRendered(IBlockAccess p_149646_1_, int p_149646_2_, int p_149646_3_, int p_149646_4_, int p_149646_5_)
    {
        ...
        return !Minecraft.getMinecraft().gameSettings.fancyGraphics && block == this ? false : super.shouldSideBeRendered(p_149646_1_, p_149646_2_, p_149646_3_, p_149646_4_, p_149646_5_);
    }
    ...
    {
        return Minecraft.getMinecraft().gameSettings.fancyGraphics ? this.iFancy : this.iFast;
    }
    
    @SideOnly(Side.CLIENT)
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        this.iFast = p_149651_1_.registerIcon(YetAnotherMod.MODID + ":" + this.texture + "/fast");
        this.iFancy = p_149651_1_.registerIcon(YetAnotherMod.MODID + ":" + this.texture + "/fancy");
    }
