...
public class BlockNukeFire extends BlockFire {
	
	public BlockNukeFire(String texture)
    {
        super();
    ...
    {
        if (p_149841_6_.nextInt(p_149841_5_) < 50)
        {
            ...
            {
        		if (p_149841_6_.nextInt(2) == 0) {
        			p_149841_1_.setBlock(p_149841_2_, p_149841_3_, p_149841_4_, YetAnotherMod.nuclearWaste);
        		} else if (p_149841_1_.getBlock(p_149841_2_, p_149841_3_, p_149841_4_) != YetAnotherMod.nuclearWaste) {
        			p_149841_1_.setBlock(p_149841_2_, p_149841_3_, p_149841_4_, Blocks.air);
        		}
            }
	...
	public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_) {
		if (p_149670_5_ instanceof EntityLivingBase) {
			((EntityLivingBase) p_149670_5_).addPotionEffect(new PotionEffect(CustomPotion.radiation.id, 50, 2));
		}
	}
