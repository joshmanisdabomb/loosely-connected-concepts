...
public abstract class LCCBlocks {
	...
	public static void init(Register<Block> e) {
		...
		//Computing
		add(computing = new ComputingBlock(Block.Properties.create(Material.IRON, DyeColor.GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(1).hardnessAndResistance(5.0F, 0.0F).variableOpacity().sound(SoundType.METAL).notSolid()), new ResourceLocation(LCC.MODID, "computing"));
		...
		}, Block.Properties.create(Material.ORGANIC, MaterialColor.TNT).harvestTool(ToolType.SHOVEL).harvestLevel(0).hardnessAndResistance(0.6F, 3.0F).tickRandomly().sound(SoundType.PLANT)), new ResourceLocation(LCC.MODID, "rainbow_grass_block"));
		...
		}, Block.Properties.create(Material.ORGANIC, MaterialColor.PINK_TERRACOTTA).harvestTool(ToolType.SHOVEL).harvestLevel(0).hardnessAndResistance(0.6F, 3.0F).tickRandomly().sound(SoundType.PLANT)), new ResourceLocation(LCC.MODID, "sugar_grass_block"));
		addWithDefaultItem(star_plating = new Block(Block.Properties.create(Material.ORGANIC, MaterialColor.SAND).harvestTool(ToolType.SHOVEL).harvestLevel(0).hardnessAndResistance(0.6F, 3.0F).tickRandomly().sound(SoundType.GLASS)), new ResourceLocation(LCC.MODID, "star_plating"));
		factory(sparkling_grass_block, color -> addWithDefaultItem(new SparklingGrassBlock(color, Block.Properties.create(Material.ORGANIC, color).harvestTool(ToolType.SHOVEL).harvestLevel(0).hardnessAndResistance(0.6F, 3.0F).tickRandomly().sound(SoundType.GLASS)), new ResourceLocation(LCC.MODID, "sparkling_grass_block_" + color.getName())), DyeColor.values());
		addWithDefaultItem(sparkling_dirt = new Block(Block.Properties.create(Material.ORGANIC, MaterialColor.YELLOW).harvestTool(ToolType.SHOVEL).harvestLevel(0).hardnessAndResistance(0.5F, 2.5F).sound(SoundType.GROUND)), new ResourceLocation(LCC.MODID, "sparkling_dirt"));
		addWithDefaultItem(twilight_stone = new Block(Block.Properties.create(Material.ROCK, MaterialColor.PURPLE_TERRACOTTA).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(1.5F, 6.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "twilight_stone"));
		addWithDefaultItem(twilight_cobblestone = new Block(Block.Properties.create(Material.ROCK, MaterialColor.PURPLE_TERRACOTTA).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 6.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "twilight_cobblestone"));

		addWithDefaultItem(candy_cane_red = new CandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.PINK).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "candy_cane_red"));
		addWithDefaultItem(candy_cane_green = new CandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "candy_cane_green"));
		addWithDefaultItem(candy_cane_blue = new CandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "candy_cane_blue"));
		addWithDefaultItem(stripped_candy_cane = new PillarBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "stripped_candy_cane"));
		addWithDefaultItem(candy_cane_coating_red = new CandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.PINK).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "candy_cane_coating_red"));
		addWithDefaultItem(candy_cane_coating_green = new CandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "candy_cane_coating_green"));
		addWithDefaultItem(candy_cane_coating_blue = new CandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "candy_cane_coating_blue"));
		addWithDefaultItem(stripped_candy_cane_coating = new PillarBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "stripped_candy_cane_coating"));
		addWithDefaultItem(refined_candy_cane_red = new RefinedCandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.PINK).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_candy_cane_red"));
		addWithDefaultItem(refined_candy_cane_green = new RefinedCandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_candy_cane_green"));
		addWithDefaultItem(refined_candy_cane_blue = new RefinedCandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_candy_cane_blue"));
		addWithDefaultItem(refined_stripped_candy_cane = new PillarBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_stripped_candy_cane"));
		addWithDefaultItem(refined_candy_cane_coating_red = new RefinedCandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.PINK).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_candy_cane_coating_red"));
		addWithDefaultItem(refined_candy_cane_coating_green = new RefinedCandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_candy_cane_coating_green"));
		addWithDefaultItem(refined_candy_cane_coating_blue = new RefinedCandyCaneBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_candy_cane_coating_blue"));
		addWithDefaultItem(refined_stripped_candy_cane_coating = new PillarBlock(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "refined_stripped_candy_cane_coating"));
		addWithDefaultItem(candy_cane_block = new Block(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(0).hardnessAndResistance(2.0F, 1.0F).sound(SoundType.STONE)), new ResourceLocation(LCC.MODID, "candy_cane_block"));

		addWithDefaultItem(vivid_log = new LogBlock(MaterialColor.PINK, Block.Properties.create(Material.WOOD, MaterialColor.RED_TERRACOTTA).harvestTool(ToolType.AXE).harvestLevel(0).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "vivid_log"));
		addWithDefaultItem(vivid_wood = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.RED_TERRACOTTA).harvestTool(ToolType.AXE).harvestLevel(0).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "vivid_wood"));
		addWithDefaultItem(vivid_planks = new Block(Block.Properties.create(Material.WOOD, MaterialColor.PINK).harvestTool(ToolType.AXE).harvestLevel(0).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "vivid_planks"));
		...
		addWithDefaultItem(vivid_leaves = new LeavesBlock(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT).notSolid()), new ResourceLocation(LCC.MODID, "vivid_leaves"));
		addWithDefaultItem(stripped_vivid_log = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PINK_TERRACOTTA).harvestTool(ToolType.AXE).harvestLevel(0).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "stripped_vivid_log"));
		addWithDefaultItem(stripped_vivid_wood = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PINK_TERRACOTTA).harvestTool(ToolType.AXE).harvestLevel(0).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "stripped_vivid_wood"));
		...
		addWithDefaultItem(vivid_slab = new SlabBlock(Block.Properties.from(vivid_planks).hardnessAndResistance(2.0F, 3.0F)), new ResourceLocation(LCC.MODID, "vivid_slab"));
		add(vivid_door = new AccessibleDoorBlock(Block.Properties.create(Material.WOOD, MaterialColor.PINK).harvestTool(ToolType.AXE).harvestLevel(0).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid()), new ResourceLocation(LCC.MODID, "vivid_door"));
		...
		addWithDefaultItem(vivid_pressure_plate = new AccessiblePressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, MaterialColor.PINK).harvestTool(ToolType.AXE).harvestLevel(0).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "vivid_pressure_plate"));
		addWithDefaultItem(vivid_button = new AccessibleWoodButtonBlock(Block.Properties.create(Material.MISCELLANEOUS).harvestTool(ToolType.AXE).harvestLevel(0).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "vivid_button"));
		...
		add(chocolate = new ChocolateBlock(Block.Properties.create(Material.WOOD, ChocolateBlock.Type.MILK.mapColor).harvestTool(ToolType.AXE).harvestLevel(0).hardnessAndResistance(2.8F, 1.5F).sound(SoundType.WOOD)), new ResourceLocation(LCC.MODID, "chocolate"));
