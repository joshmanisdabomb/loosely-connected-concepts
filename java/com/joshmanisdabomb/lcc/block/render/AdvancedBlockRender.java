...
public interface AdvancedBlockRender {
    ...
    Function<ResourceLocation, TextureAtlasSprite> blockTextureGetter = rl -> ModelLoader.defaultTextureGetter().apply(new Material(AtlasTexture.LOCATION_BLOCKS_TEXTURE, rl));
