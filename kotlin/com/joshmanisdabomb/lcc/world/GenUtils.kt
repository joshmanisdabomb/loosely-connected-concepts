...
object GenUtils {
    ...
    fun areaMatches(world: StructureWorldAccess, x1: Int, y1: Int, z1: Int, x2: Int = x1, y2: Int = y1, z2: Int = z1, expand: Int = 0, ex: Int = 0, ey: Int = 0, ez: Int = 0, height: Int = 0, test: (match: Boolean?) -> Boolean? = ::all, match: (pos: BlockPos) -> Boolean = { bp -> world.isAir(bp) }): Boolean {
