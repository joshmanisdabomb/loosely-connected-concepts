...
public class AimaggBlockWool extends AimaggBlockBasic {

    public static final PropertyInteger COLOR = PropertyInteger.create("color", 0, 15);
	private final boolean classicColors;

	public AimaggBlockWool(boolean classicColors, String internalName, Material material) {
	...
	public MapColor getMapColor(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		if (classicColors) {
			return AimaggBlockWool.getClassicMapColor(state.getValue(COLOR));
		} else {
