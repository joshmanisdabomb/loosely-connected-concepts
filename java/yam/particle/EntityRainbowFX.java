...
public class EntityRainbowFX extends EntityFX {
    ...
    private static final ResourceLocation texture = new ResourceLocation(YetAnotherMod.MODID, "textures/particle/rainbow.png");
	private Random rand = new Random();
	private float initialParticleScale;
    
	public EntityRainbowFX(World par1World, double x, double y, double z) {
        ...
        setScale(1.0F+(rand.nextFloat()*4));
        setGravity(0.5F);
    }
	
	public EntityRainbowFX(World par1World, double x, double y, double z, double speedX, double speedY, double speedZ) {
	...
	private void newRandomColour() {
		Color col = Color.getHSBColor(rand.nextFloat(),1.0F,1.0F);
    ...
    public EntityRainbowFX setMaxAge(int maxAge) {
    	particleMaxAge = maxAge;
    	return this;
    }

    public EntityRainbowFX setGravity(float gravity) {
    	particleGravity = gravity;
    	return this;
    }
    
    public EntityRainbowFX setScale(float scale) {
    	particleScale = scale;
