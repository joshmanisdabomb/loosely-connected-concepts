package com.joshmanisdabomb.aimagg.gen.classic;
...
public class WorldGenBigClassicTree extends WorldGenerator {

	public static final IBlockState LOG = Blocks.LOG.getDefaultState();
	public static final IBlockState LEAVES = AimaggBlocks.classicLeaves.getDefaultState().withProperty(AimaggBlockClassicLeaves.DISTANCE_FROM_SUPPORT, 1);
	
    public WorldGenBigClassicTree(boolean notify) {
        super(notify);
    }
    ...
    void limb(BlockPos p_175937_1_, BlockPos p_175937_2_, IBlockState log)
    {
    ...
    void generateTrunk()
    {
        ...
        this.limb(blockpos, blockpos1, LOG);

        if (this.trunkSize == 2)
        {
            this.limb(blockpos.east(), blockpos1.east(), LOG);
            this.limb(blockpos.east().south(), blockpos1.east().south(), LOG);
            this.limb(blockpos.south(), blockpos1.south(), LOG);
        }
    }
    ...
    void generateLeafNodeBases()
    {
        for (FoliageCoordinates foliagecoordinates : this.foliageCoords)
        {
            ...
            {
                this.limb(blockpos, foliagecoordinates, LOG);
            }
        }
    }
    ...
    private boolean validTreeLocation()
    {
        ...
        boolean isSoil = state.getBlock().canSustainPlant(state, this.world, down, net.minecraft.util.EnumFacing.UP, (IPlantable)AimaggBlocks.classicSapling);
