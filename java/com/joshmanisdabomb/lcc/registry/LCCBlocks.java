...
public abstract class LCCBlocks {
	...
	public static void init(Register<Block> e) {
		//Test Blocks
		all.add(test_block = new Block(Block.Properties.create(Material.ROCK, DyeColor.YELLOW)).setRegistryName(LCC.MODID, "test_block"));
		createDefaultBlockItem(test_block);
		all.add(test_block_2 = new TestHorizontalBlock(Block.Properties.create(Material.ROCK, DyeColor.YELLOW)).setRegistryName(LCC.MODID, "test_block_2"));
		createDefaultBlockItem(test_block_2);
		all.add(test_block_3 = new TestDirectionalBlock(Block.Properties.create(Material.ROCK, DyeColor.YELLOW)).setRegistryName(LCC.MODID, "test_block_3"));
		createDefaultBlockItem(test_block_3);
		all.add(test_block_4 = new TestPillarBlock(Block.Properties.create(Material.ROCK, DyeColor.YELLOW)).setRegistryName(LCC.MODID, "test_block_4"));
		createDefaultBlockItem(test_block_4);
		all.add(test_block_5 = new Block(Block.Properties.create(Material.ROCK, DyeColor.YELLOW)).setRegistryName(LCC.MODID, "test_block_5"));
		createDefaultBlockItem(test_block_5);

		//Resources
		all.add(ruby_ore = new Block(Block.Properties.create(Material.ROCK)).setRegistryName(LCC.MODID, "ruby_ore"));
		...
		all.add(topaz_ore = new Block(Block.Properties.create(Material.ROCK)).setRegistryName(LCC.MODID, "topaz_ore"));
		...
		all.add(sapphire_ore = new Block(Block.Properties.create(Material.ROCK)).setRegistryName(LCC.MODID, "sapphire_ore"));
		createDefaultBlockItem(sapphire_ore);
		all.add(sapphire_storage = new Block(Block.Properties.create(Material.ROCK, DyeColor.BLUE)).setRegistryName(LCC.MODID, "sapphire_storage"));
		createDefaultBlockItem(sapphire_storage);
		all.add(amethyst_ore = new Block(Block.Properties.create(Material.ROCK)).setRegistryName(LCC.MODID, "amethyst_ore"));
		createDefaultBlockItem(amethyst_ore);
		all.add(amethyst_storage = new Block(Block.Properties.create(Material.ROCK, DyeColor.PURPLE)).setRegistryName(LCC.MODID, "amethyst_storage"));
		createDefaultBlockItem(amethyst_storage);
		all.add(uranium_ore = new Block(Block.Properties.create(Material.ROCK)).setRegistryName(LCC.MODID, "uranium_ore"));
		createDefaultBlockItem(uranium_ore);
		all.add(uranium_storage = new Block(Block.Properties.create(Material.ROCK, DyeColor.LIME)).setRegistryName(LCC.MODID, "uranium_storage"));
		createDefaultBlockItem(uranium_storage);
		all.add(enriched_uranium_storage = new Block(Block.Properties.create(Material.ROCK, DyeColor.LIME)).setRegistryName(LCC.MODID, "enriched_uranium_storage"));
		createDefaultBlockItem(enriched_uranium_storage);

		//Nuclear
		all.add(nuclear_waste = new NuclearWasteBlock(Block.Properties.create(Material.ROCK, MaterialColor.CYAN_TERRACOTTA).hardnessAndResistance(-1.0F, 3600000.0F)).setRegistryName(LCC.MODID, "nuclear_waste"));
