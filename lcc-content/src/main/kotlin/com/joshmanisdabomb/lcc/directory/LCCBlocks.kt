...
object LCCBlocks : BlockDirectory() {
    ...
    val topaz_cluster by create(BlockExtraSettings().creativeEx(RESOURCES, sortValueInt(105)).cutout()) { AmethystClusterBlock(7, 3, FabricBlockSettings.of(Material.AMETHYST, MapColor.TERRACOTTA_WHITE).breakByTool(PICKAXES, 2).ticksRandomly().nonOpaque().strength(1.5f).luminance { it[Properties.LIT].toInt(5) }.sounds(BlockSoundGroup.AMETHYST_CLUSTER)) }
    val large_topaz_bud by create(BlockExtraSettings().creativeEx(RESOURCES, sortValueInt(104)).cutout()) { AmethystClusterBlock(5, 3, FabricBlockSettings.copy(topaz_cluster).luminance { it[Properties.LIT].toInt(4) }.sounds(BlockSoundGroup.MEDIUM_AMETHYST_BUD)) }
    val medium_topaz_bud by create(BlockExtraSettings().creativeEx(RESOURCES, sortValueInt(103)).cutout()) { AmethystClusterBlock(4, 3, FabricBlockSettings.copy(topaz_cluster).luminance { it[Properties.LIT].toInt(2) }.sounds(BlockSoundGroup.LARGE_AMETHYST_BUD)) }
    val small_topaz_bud by create(BlockExtraSettings().creativeEx(RESOURCES, sortValueInt(102)).cutout()) { AmethystClusterBlock(3, 4, FabricBlockSettings.copy(topaz_cluster).luminance { it[Properties.LIT].toInt(1) }.sounds(BlockSoundGroup.SMALL_AMETHYST_BUD)) }
    ...
    //Nuclear
    val uranium_ore by create(BlockExtraSettings().creativeEx(NUCLEAR, sortValueInt(0))) { RadioactiveBlock(2, 0, FabricBlockSettings.of(Material.STONE).strength(3.0F).breakByTool(PICKAXES, 3)) }
    val uranium_block by create(BlockExtraSettings().creativeEx(NUCLEAR, sortValueInt(11))) { RadioactiveBlock(3, 0, FabricBlockSettings.of(Material.METAL, MapColor.LIME).strength(5.0F, 6.0F).breakByTool(PICKAXES, 3).sounds(BlockSoundGroup.METAL)) }
    val enriched_uranium_block by create(BlockExtraSettings().creativeEx(NUCLEAR, sortValueInt(21))) { RadioactiveBlock(3, 1, FabricBlockSettings.of(Material.METAL, MapColor.LIME).strength(5.0F, 6.0F).breakByTool(PICKAXES, 3).sounds(BlockSoundGroup.METAL)) }
    val heavy_uranium_block by create(BlockExtraSettings().creativeEx(NUCLEAR, sortValueInt(31))) { RadioactiveBlock(3, 0, FabricBlockSettings.of(Material.METAL, MapColor.GREEN).strength(5.0F, 6.0F).breakByTool(PICKAXES, 3).sounds(BlockSoundGroup.METAL)) }
    ...
    val energy_bank by create(BlockExtraSettings().creativeEx(POWER)) { EnergyBankBlock(FabricBlockSettings.of(Material.METAL, MapColor.ORANGE).strength(4.0F, 5.0F).breakByTool(PICKAXES, 1).requiresTool().sounds(BlockSoundGroup.COPPER)) }
    val power_source by create(BlockExtraSettings().creativeEx(POWER, sortValueInt(1000))) { PowerSourceBlock(FabricBlockSettings.of(Material.METAL, MapColor.CYAN).strength(-1.0F, 3600000f).dropsNothing().sounds(BlockSoundGroup.COPPER)) }
