...
public class AimaggPacketLaunchPadUpdateRequestServer implements IMessage {
	
	private int teX;
	private int teY;
	private int teZ;

	public AimaggPacketLaunchPadUpdateRequestServer() {}
	...
	public static class Handler implements IMessageHandler<AimaggPacketLaunchPadUpdateRequestServer, IMessage> {
        @Override
        public IMessage onMessage(final AimaggPacketLaunchPadUpdateRequestServer message, final MessageContext ctx) {
        ...
        private void handle(AimaggPacketLaunchPadUpdateRequestServer message, MessageContext ctx) {
        	...
        	if (te instanceof AimaggTELaunchPad) {
        		AimaggPacketLaunchPadUpdateResponseClient packet = new AimaggPacketLaunchPadUpdateResponseClient();
