...
import yam.gen.sheol.MapGenCavesSheol;
import cpw.mods.fml.common.eventhandler.Event.Result;

public class ChunkProviderSheol implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    private MapGenBase caveGenerator = new MapGenCavesSheol();
    ...
    public ChunkProviderSheol(World par1World, long par2) {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = ((BiomeSheol)YetAnotherMod.biomeSheol).stoneBlock;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
                                    p_147424_3_[j3 += short1] = ((BiomeSheol)YetAnotherMod.biomeSheol).seaBlock;
                                }
                                else
                                {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        int k = par2 * 16;
        int l = par3 * 16;
        BiomeGenBase biomegenbase = YetAnotherMod.biomeSheol;
