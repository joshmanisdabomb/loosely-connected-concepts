...
object LCCKnowledgeData : BasicDirectory<KnowledgeArticleBuilder, Unit>() {
    ...
    val block_improvised_explosive by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.improvised_explosive)
            ...
            .addSection(KnowledgeArticleSectionBuilder("Usage")
                ...
                .addFragment(KnowledgeArticleTextFragmentBuilder("If an active explosive is right clicked with %s, the block will be defused and drop as if it was broken with a pickaxe.")
    ...
    val entity_consumer by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCEntities.consumer)
            ...
            .addSection(KnowledgeArticleSectionBuilder("Drops")
                ...
                .addFragment(KnowledgeArticleLootFragmentBuilder(KnowledgeArticleTextFragmentBuilder("Can only drop when the %s's tongue is extended.").insert(LCCEntities.consumer.name)) { listOf(it.da.lootTableStore[LCCEntities.consumer_tongue]!!) }
                )
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
    ...
    val block_rusty_iron by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.rusted_iron_blocks.values.last())
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s is a resource block introduced in %s that can be obtained by surrounding a regular %s in %s in the %s biome. It can be broken down into 9 %s which is used to craft the third tier of %s tools as well as %s %s. It must be mined with a %s or higher.")
    ...
    val item_iron_oxide by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCItems.iron_oxide)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s is a resource introduced in %s. It can be crafted in groups of 9 by placing a %s in a crafting table. It is used to craft the third tier of %s tools as well as %s %s.")
    ...
    val block_shattered_glass by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.shattered_glass)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                ...
                .addFragment(KnowledgeArticleTextFragmentBuilder("This is the full block version of %s.")
                    .insertLink("Shattered Glass Panes", KnowledgeArticleIdentifier.ofBlock(LCCBlocks.shattered_glass_pane).link)
                )
            )
    ...
    val block_shattered_glass_pane by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.shattered_glass_pane)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s is a transparent block introduced in %s that is obtained by smashing (right clicking) %s and all %s of %s with a %s. It is extremely fragile and breaks easily when stepped on or shot with a projectile.")
                ...
                .addFragment(KnowledgeArticleTextFragmentBuilder("This is the glass pane version of %s.")
                    .insertLink(LCCBlocks.shattered_glass.name, KnowledgeArticleIdentifier.ofBlock(LCCBlocks.shattered_glass).link)
                )
            )
            .addSection(KnowledgeArticleSectionBuilder("Types")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCBlocks.shattered_glass_pane) })
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { LCCBlocks.stained_shattered_glass_pane.values.flatMap { b -> it.da.recipeStore.findRecipes(b) } })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCBlocks.shattered_glass_pane) })
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { LCCBlocks.stained_shattered_glass_pane.values.flatMap { b -> it.da.recipeStore.findUsages(b) } })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleBlockInfoSectionBuilder(renewable = true))
    ...
    val block_cracked_mud by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.cracked_mud)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s is a block originally introduced in %s and reintroduced in %s that covers the surface of the %s. %s can be hydrated into %s, a process which can be reversed.")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Interactions")
                ...
                .addFragment(KnowledgeArticleTextFragmentBuilder("To slowly dry %s back into %s, it can be left in the %s without adjacent %s. %s can be quickly dried by smelting it in a %s or %s.")
                    .insert(LCCBlocks.mud.name)
                    .insert(LCCBlocks.cracked_mud.name)
                    .insert("Wasteland")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCBlocks.cracked_mud) })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCBlocks.cracked_mud) })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleBlockInfoSectionBuilder(renewable = false))
    ...
    val block_mud by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.mud)
            ...
            .addSection(KnowledgeArticleSectionBuilder("Movement")
                ...
                .addFragment(KnowledgeArticleTextFragmentBuilder("Previously in %s, %s is a ridiculously slippery block, allowing entities walking on it to wildly accelerate and travel huge distances very quickly.")
                    .insert(LCCVersion.YAM_1.label)
                    .insert(LCCBlocks.mud.name)
                )
            )
            .addSection(KnowledgeArticleSectionBuilder("Interactions")
                .addFragment(KnowledgeArticleTextFragmentBuilder("When left in the %s without adjacent %s, %s will slowly dry into %s. %s can also be quickly dried by smelting it in a %s or %s.")
                    .insertLink("Wasteland", KnowledgeArticleIdentifier(BuiltinRegistries.BIOME.key.value, LCC.id("wasteland")).link)
                    .insertLink(Blocks.WATER.name, KnowledgeArticleIdentifier.ofBlock(Blocks.WATER).link)
                    .insert(LCCBlocks.mud.name)
                    .insert(LCCBlocks.cracked_mud.name)
                ...
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s can be rehydrated into %s by being placed in or adjacent to %s.")
                    .insert(LCCBlocks.cracked_mud.name)
                    .insert(LCCBlocks.mud.name)
                    .insertLink(Blocks.WATER.name, KnowledgeArticleIdentifier.ofBlock(Blocks.WATER).link)
                )
            ...
            .addSection(KnowledgeArticleSectionBuilder("1.19")
                .addFragment(KnowledgeArticleTextFragmentBuilder("This block will likely be merged with the Mud Block from Minecraft 1.19 once released. It is planned to migrate the functionality of drying into %s to this new block.")
                    .insert(LCCBlocks.cracked_mud.name)
                )
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCBlocks.mud) })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCBlocks.mud) })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleBlockInfoSectionBuilder(renewable = false))
    ...
    val block_cracked_mud_pressure_plate by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.cracked_mud_pressure_plate)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("The %s is a pressure plate introduced in %s. It is activated when sprinted on or landed on from a height, and will deactivate once there are no entities on it.")
                    .insert(LCCBlocks.cracked_mud_pressure_plate.name)
                    .insertLink(LCCVersion.LCC_FABRIC_0_5_0.label, LCCVersion.LCC_FABRIC_0_5_0.page.link)
                )
            )
            .addSection(KnowledgeArticleSectionBuilder("Obtaining")
                .addFragment(KnowledgeArticleTextFragmentBuilder("%ss can be generated in the %s as the activation mechanism of landmines, which will immediately activate the %s that generates below. If the pressure plate is deactivated, the %s will instantly detonate.")
                    .insert(LCCBlocks.cracked_mud_pressure_plate.name)
                    .insertLink("Wasteland", KnowledgeArticleIdentifier(BuiltinRegistries.BIOME.key.value, LCC.id("wasteland")).link)
                    .insertLink(LCCBlocks.improvised_explosive.name, KnowledgeArticleIdentifier.ofBlock(LCCBlocks.improvised_explosive).link)
                    .insert(LCCBlocks.improvised_explosive.name)
                )
                .addFragment(KnowledgeArticleTextFragmentBuilder("It can also be crafted with 2 %s blocks.")
                    .insertLink(LCCBlocks.cracked_mud.name, KnowledgeArticleIdentifier.ofBlock(LCCBlocks.cracked_mud).link)
                )
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCBlocks.cracked_mud_pressure_plate) })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCBlocks.cracked_mud_pressure_plate) })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleBlockInfoSectionBuilder(renewable = false))
    ...
    val item_iron_oxide_nugget by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCItems.iron_oxide_nugget)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%ss are a crafting material introduced in %s. It can be crafted in groups of 9 by placing a %s in a crafting table.")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCItems.iron_oxide_nugget) })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCItems.iron_oxide_nugget) })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleItemInfoSectionBuilder(renewable = true))
            .tags("Wasteland", "Materials", "Rusted Iron", "Resources")
    ...
    val block_spikes by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.spikes)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s are a set of blocks introduced in %s. They can be placed on a block to face in any direction and will deal damage to entities touching the spiked side whilst slowing their movement speed.")
                    .insert(LCCBlocks.spikes.name)
                    .insertLink(LCCVersion.LCC_FABRIC_0_5_0.label, LCCVersion.LCC_FABRIC_0_5_0.page.link)
                )
            )
            .addSection(KnowledgeArticleSectionBuilder("Obtaining")
                .addFragment(KnowledgeArticleTextFragmentBuilder("All %s can be found in the %s in the form of spike traps. They are square holes that are easy to spot on the surface, with a bed of a random type of %s at the bottom. Plain %s are the most common to find in spike traps.")
                    .insert(LCCBlocks.spikes.name)
                    .insertLink("Wasteland Barrens", KnowledgeArticleIdentifier.ofBiome(LCCBiomes.wasteland_barrens).link)
                    .insert(LCCBlocks.spikes.name)
                    .insert(LCCBlocks.spikes.name)
                )
                .addFragment(KnowledgeArticleTextFragmentBuilder("Regular %s can be crafted with %s and %s, and then upgraded to another type with their respective ingredient:")
                    .insert(LCCBlocks.spikes.name)
                    .insertLink(LCCItems.iron_oxide.name, KnowledgeArticleIdentifier.ofItem(LCCItems.iron_oxide).link)
            ...
            .addSection(KnowledgeArticleSectionBuilder("Damage")
                .addFragment(KnowledgeArticleTextFragmentBuilder("All %s will constantly deal damage to an entity while it is in motion. The exact amount of damage received starts at half a heart and increases exponentially depending on the entity's current speed.")
                    .insert(LCCBlocks.spikes.name)
                )
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s deal increased damage to entities by modifying the calculated damage to the power of 1.2 and then doubling it.")
                    .insert(LCCBlocks.bleeding_spikes.name)
                )
                .addFragment(KnowledgeArticleTextFragmentBuilder("When mobs and players are damaged by %s, a poison effect is applied for 8.5 seconds.")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { LCCBlocks.all.values.filterIsInstance<SpikesBlock>().flatMap { b -> it.da.recipeStore.findRecipes(b) } })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleBlockInfoSectionBuilder(renewable = true))
    ...
    val block_rusted_iron_bars by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCBlocks.rusted_iron_bars)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s is a decorative block introduced in %s. They are the %s equivalent of %s.")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCBlocks.rusted_iron_bars) })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCBlocks.rusted_iron_bars) })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleBlockInfoSectionBuilder(renewable = true))
    ...
    val item_tongue_tissue by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCItems.tongue_tissue)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s is a material introduced in %s. They are rarely dropped by %s when their tongue is extended.")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCItems.tongue_tissue) })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCItems.tongue_tissue) })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleItemInfoSectionBuilder(renewable = true))
    ...
    val item_altar_challenge_key by entry(::initialiser) {
        KnowledgeArticleBuilder(LCCItems.altar_challenge_key)
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("%s is an item introduced in %s. It allows the player to start a %s challenge, which give %s upon completion.")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Usage")
                .addFragment(KnowledgeArticleTextFragmentBuilder("Once a %s block is filled with sapphires that the player wishes to wager, the block can be right clicked with an %s to start the challenge. The key is consumed in the process.")
                    .insertLink(LCCBlocks.sapphire_altar.name, KnowledgeArticleIdentifier.ofBlock(LCCBlocks.sapphire_altar).link)
                    .insert(LCCItems.altar_challenge_key.name)
                )
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Recipes")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findRecipes(LCCItems.altar_challenge_key) })
            )
            .addSection(KnowledgeArticleSectionBuilder("Crafting Usages")
                .addFragment(KnowledgeArticleRecipeFragmentBuilder { it.da.recipeStore.findUsages(LCCItems.altar_challenge_key) })
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleItemInfoSectionBuilder(renewable = true))
    ...
    val structure_sapphire_altar by entry(::initialiser) {
        KnowledgeArticleBuilder(KnowledgeArticleIdentifier.ofStructure(LCCStructureFeatures.sapphire_altar), "Sapphire Altar")
            .addSection(KnowledgeArticleSectionBuilder(introduction)
                .addFragment(KnowledgeArticleTextFragmentBuilder("The Sapphire Altar is a structure introduced in %s. It is a common structure found in all %s biomes that presents a random challenge to players. Completing this challenge gives %s as a reward, used to make the final tier of %s tools and %s.")
                    .insertLink(LCCVersion.LCC_FABRIC_0_5_0.label, LCCVersion.LCC_FABRIC_0_5_0.page.link)
                    .insertLink("Wasteland", KnowledgeArticleIdentifier(BuiltinRegistries.BIOME.key.value, LCC.id("wasteland")).link)
                    .insertLink("sapphires", KnowledgeArticleIdentifier.ofItem(LCCItems.sapphire).link)
                    .insert("Wasteland")
            ...
            .addSection(KnowledgeArticleSectionBuilder("Structure")
                .addFragment(KnowledgeArticleTextFragmentBuilder("The base of the structure is comprised of %s, with a staircase of %s on one side leading to the top of the structure.")
                    .insertLink(LCCBlocks.sapphire_altar_brick.name, KnowledgeArticleIdentifier.ofBlock(LCCBlocks.sapphire_altar_brick).link)
                ...
                .addFragment(KnowledgeArticleTextFragmentBuilder("The top of the structure is entirely dependent on the challenge posed by the altar, but they will all generate with one %s block. This block provides an interface to the structure itself.")
                    .insertLink(LCCBlocks.sapphire_altar.name, KnowledgeArticleIdentifier.ofBlock(LCCBlocks.sapphire_altar).link)
                )
            )
            .addSection(KnowledgeArticleChangelogSectionBuilder())
            .addSection(KnowledgeArticleSectionBuilder("Image", "info")
                .addFragment(KnowledgeArticleImageFragmentBuilder()
                    .addStatic("structure/sapphire_altar", KnowledgeArticleTextFragmentBuilder("A Sapphire Altar generated in the %s.")
                        .insertLink("Wasteland Spikes", KnowledgeArticleIdentifier.ofBiome(LCCBiomes.wasteland_spikes).link)
                    )
                )
            )
