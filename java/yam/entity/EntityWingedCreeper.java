...
public class EntityWingedCreeper extends EntityMob implements IRangedAttackMob {

	public EntityWingedCreeper(World par1World) {
		super(par1World);

        this.getNavigator().setAvoidsWater(true);

        this.tasks.addTask(0, new EntityAIArrowAttack(this, 1.0D, 1, 1, 4.0F));
    ...
    {
		return new ItemStack(YetAnotherMod.wingedCreeperSpawnEgg, 1);
    }
