...
public class GenTreeClassic extends GenTree {
	...
	public boolean generateFromSapling(World world, Random rand, int x, int y, int z) {
        ...
        if (y >= 1 && y + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = ((BlockCustomSapling)YetAnotherMod.nostalgiaSapling).isBlockValidBase(block2);
                if (isSoil && y < 256 - l - 1)
                {
                        ...
                        for (i2 = x - l1; i2 <= x + l1; ++i2)
                        {
                            ...
                            for (int k2 = z - l1; k2 <= z + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || rand.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        world.setBlock(i2, k1, k2, YetAnotherMod.nostalgiaLeaves, 0, 3);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                        	world.setBlock(x, y + k1, z, Blocks.log, 0, 3);
                        }
                    }
