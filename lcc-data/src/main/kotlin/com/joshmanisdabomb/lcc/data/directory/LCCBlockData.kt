...
object LCCBlockData : BasicDirectory<BlockDataContainer, Unit>() {
    ...
    val cut_tungsten_stairs by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(StairsBlockAssetFactory(LCC.id("block/cut_tungsten"))).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.cut_tungsten)).add(StonecutterItemRecipeFactory(LCCBlocks.tungsten_block, name = LCC.id("cut_tungsten_stairs_from_tungsten_block_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.cut_tungsten)) }
    ...
    val rubber_stairs by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(StairsBlockAssetFactory(LCC.id("block/rubber_planks"))).add(BlockTagFactory(BlockTags.WOODEN_STAIRS)).add(ItemTagFactory(ItemTags.WOODEN_STAIRS)).add(StairsRecipeFactory(LCCBlocks.rubber_planks, group = "wooden_stairs")) }
    val rubber_slab by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().add(SlabBlockAssetFactory(LCC.id("block/rubber_planks")) { d, b -> loc(LCCBlocks.rubber_planks) }).add(BlockTagFactory(BlockTags.WOODEN_SLABS)).add(ItemTagFactory(ItemTags.WOODEN_SLABS)).add(SlabRecipeFactory(LCCBlocks.rubber_planks, group = "wooden_slab")).add(SlabLootFactory) }
    val rubber_door by entry(::initialiser) { BlockDataContainer().defaultLang().add(DoorBlockAssetFactory).add(GeneratedItemAssetFactory).add(DoorBlockLootFactory).add(BlockTagFactory(BlockTags.WOODEN_DOORS)).add(ItemTagFactory(ItemTags.WOODEN_DOORS)).add(DoorRecipeFactory(LCCBlocks.rubber_planks, group = "wooden_door")) }
    ...
    val rubber_fence_gate by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().defaultItemAsset().add(FenceGateBlockAssetFactory(LCC.id("block/rubber_planks"))).add(BlockTagFactory(BlockTags.FENCE_GATES)).add(FenceGateRecipeFactory(LCCBlocks.rubber_planks, Ingredient.ofItems(Items.STICK), group = "wooden_fence_gate")) }
    val rubber_trapdoor by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().defaultItemAsset().add(TrapdoorBlockAssetFactory).add(BlockTagFactory(BlockTags.WOODEN_TRAPDOORS)).add(ItemTagFactory(ItemTags.WOODEN_TRAPDOORS)).add(TrapdoorRecipeFactory(LCCBlocks.rubber_planks, group = "wooden_trapdoor")) }
    val rubber_sign by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().add(ParticleBlockAssetFactory(LCC.block("rubber_planks"))).add(GeneratedItemAssetFactory).add(BlockTagFactory(BlockTags.STANDING_SIGNS)).add(ItemTagFactory(ItemTags.SIGNS)).add(SignRecipeFactory(LCCBlocks.rubber_planks, Ingredient.ofItems(Items.STICK), group = "wooden_sign")) }
    val rubber_wall_sign by entry(::initialiser) { BlockDataContainer().add(ParticleBlockAssetFactory(LCC.block("rubber_planks"))).add(BlockTagFactory(BlockTags.WALL_SIGNS)) }
    ...
    val classic_cobblestone_stairs by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(StairsBlockAssetFactory(LCC.id("block/classic_cobblestone"))).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.classic_cobblestone)).add(RiftFromItemRecipeFactory(Blocks.COBBLESTONE_STAIRS)).add(StonecutterItemRecipeFactory(LCCBlocks.classic_cobblestone)) }
    ...
    val classic_brick_stairs by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(StairsBlockAssetFactory(LCC.id("block/classic_bricks"))).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.classic_bricks)).add(RiftFromItemRecipeFactory(Blocks.BRICK_STAIRS)).add(StonecutterItemRecipeFactory(LCCBlocks.classic_bricks)) }
    val classic_brick_slab by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().add(SlabBlockAssetFactory(LCC.id("block/classic_bricks")) { d, b -> loc(LCCBlocks.classic_bricks) }).add(BlockTagFactory(BlockTags.SLABS)).add(ItemTagFactory(ItemTags.SLABS)).add(SlabRecipeFactory(LCCBlocks.classic_bricks)).add(RiftFromItemRecipeFactory(Blocks.BRICK_SLAB)).add(SlabLootFactory).add(StonecutterItemRecipeFactory(LCCBlocks.classic_bricks, 2)) }
    val classic_mossy_cobblestone_stairs by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(StairsBlockAssetFactory(LCC.id("block/classic_mossy_cobblestone"))).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.classic_mossy_cobblestone)).add(RiftFromItemRecipeFactory(Blocks.MOSSY_COBBLESTONE_STAIRS)).add(StonecutterItemRecipeFactory(LCCBlocks.classic_mossy_cobblestone)) }
    val classic_mossy_cobblestone_slab by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().add(SlabBlockAssetFactory(LCC.id("block/classic_mossy_cobblestone")) { d, b -> loc(LCCBlocks.classic_mossy_cobblestone) }).add(BlockTagFactory(BlockTags.SLABS)).add(ItemTagFactory(ItemTags.SLABS)).add(SlabRecipeFactory(LCCBlocks.classic_mossy_cobblestone)).add(RiftFromItemRecipeFactory(Blocks.MOSSY_COBBLESTONE_SLAB)).add(SlabLootFactory).add(StonecutterItemRecipeFactory(LCCBlocks.classic_mossy_cobblestone, 2)) }
    val rhyolite_stairs by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(StairsBlockAssetFactory(LCC.id("block/rhyolite"))).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.rhyolite)).add(StonecutterItemRecipeFactory(LCCBlocks.rhyolite)) }
    val rhyolite_slab by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().add(SlabBlockAssetFactory(LCC.id("block/rhyolite")) { d, b -> loc(LCCBlocks.rhyolite) }).add(BlockTagFactory(BlockTags.SLABS)).add(ItemTagFactory(ItemTags.SLABS)).add(SlabRecipeFactory(LCCBlocks.rhyolite)).add(SlabLootFactory).add(StonecutterItemRecipeFactory(LCCBlocks.rhyolite, 2)) }
    ...
    val rock_salt by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().defaultItemAsset().add(RotationBlockAssetFactory((0..3).toList(), (0..3).toList()) { d, b -> modelCubeAll(d, b) }) }
    ...
    val salt_block by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().defaultItemAsset().add(RotationBlockAssetFactory((0..3).toList(), (0..3).toList()) { d, b -> modelCubeAll(d, b, texture = LCC.block("salt")) }).add(CustomRecipeFactory { d, i ->
        ShapedRecipeJsonFactory(i, 1)
            .pattern("sss")
            .pattern("sss")
            .pattern("sss")
