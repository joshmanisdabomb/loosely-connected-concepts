...
public class EntityAIBreakDoorAllDifficulties extends EntityAIDoorInteract {

    private int breakingTime;
    private int field_75358_j = -1;
    private static final String __OBFID = "CL_00002048";

    public EntityAIBreakDoorAllDifficulties(EntityLiving par1EntityLiving)
    {
    ...
    {
    	if (this.theEntity.worldObj.difficultySetting == EnumDifficulty.HARD) {return 100;}
    	else if (this.theEntity.worldObj.difficultySetting == EnumDifficulty.NORMAL) {return 150;}
    	return 200;
    }
