...
public class WorldGenCloud extends WorldGenMinable
{
    ...
    public WorldGenCloud(Block p_i45460_1_, int p_i45460_2_)
    {
    ...
    public WorldGenCloud(Block block, int meta, int number)
    {
        this(block, number);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        double d4 = (double)(par4 + par2Random.nextInt(2));
        double d5 = (double)(par4 + par2Random.nextInt(2));
