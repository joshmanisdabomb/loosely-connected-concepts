...
public class TileEntityTickField extends TileEntity implements IInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "Tick Field";
	}
	...
	public boolean isItemValidForSlot(int var1, ItemStack var2) {
		return var2 != null && var2.getItem() == YetAnotherMod.crystalEnergy;
	}

	public int getRange() {
		int range = 0;
		for (int i = 0; i < 5; i++) {
			if (this.stacks[i] != null && this.stacks[i].getItem() == YetAnotherMod.crystalEnergy) {
				range += 2;
			}
		}
		return range;
	...
	public int getSpeed() {
		int speed = 320;
		for (int i = 0; i < 5; i++) {
			if (this.stacks[i + 5] != null && this.stacks[i + 5].getItem() == YetAnotherMod.crystalEnergy) {
				speed /= 2;
			}
		}
		return speed;
