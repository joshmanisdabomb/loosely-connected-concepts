...
public class TeleporterSheol extends Teleporter
{
    ...
    public TeleporterSheol(WorldServer par1WorldServer)
    {
    ...
    public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        for (int x = 6; x <= 10; x++) {
            for (int z = 6; z <= 10; z++) {
            	this.worldServerInstance.setBlock(i + x, j - 2, k + z, Blocks.stone);
            }
		}
        
		par1Entity.setLocationAndAngles((double)i+8.5D, (double)j, (double)k+8.5D, 0.0F, 0.0F);
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(k1, i2, l1) == YetAnotherMod.rainbowPortal)
                        {
                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == YetAnotherMod.rainbowPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == YetAnotherMod.rainbowPortal)
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == YetAnotherMod.rainbowPortal)
            {
                j2 = 3;
            }
        ...
        for (k2 = 0; k2 < 4; ++k2)
        {
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? Blocks.sandstone : YetAnotherMod.rainbowPortal, 0, 2);
                }
            }
