...
object LCCBlockData : BasicDirectory<BlockDataContainer, Unit>(), ModelAccess {
    ...
    val cracked_mud by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().add(RotationBlockAssetFactory).add(BlockTagFactory(LCCTags.wasteland_effective)).add(BlockTagFactory(BlockTags.ENDERMAN_HOLDABLE)).add(BlockTagFactory(LCCTags.wasteland_effective)) }
