...
import com.joshmanisdabomb.lcc.abstracts.computing.controller.console.program.ConsoleProgram
...
object LCCRegistries : AdvancedDirectory<FabricRegistryBuilder<out Any, out MutableRegistry<out Any>>, MutableRegistry<out Any>, Unit, Unit>() {
    ...
    val computer_console_programs by entry(::initialiser) { FabricRegistryBuilder.createSimple(ConsoleProgram::class.java, id).attribute(RegistryAttribute.SYNCED) }
