...
object BouncePadBlockAssetFactory : BlockAssetFactory {
    ...
    override fun apply(data: DataAccessor, entry: Block) {
        ...
        val bounce_pad = LCCModelTemplates.template_bounce_pad.upload(id, textures, data.modelStates::addModel)
        val bounce_pad_settings = listOf(
            LCCModelTemplates.template_bounce_pad_0.upload(suffix(id, "0"), textures, data.modelStates::addModel),
            LCCModelTemplates.template_bounce_pad_1.upload(suffix(id, "1"), textures, data.modelStates::addModel),
            LCCModelTemplates.template_bounce_pad_2.upload(suffix(id, "2"), textures, data.modelStates::addModel),
            LCCModelTemplates.template_bounce_pad_3.upload(suffix(id, "3"), textures, data.modelStates::addModel),
            LCCModelTemplates.template_bounce_pad_4.upload(suffix(id, "4"), textures, data.modelStates::addModel)
        )
