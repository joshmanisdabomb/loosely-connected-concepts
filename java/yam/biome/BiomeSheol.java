...
public class BiomeSheol extends BiomeGenBase {

	public Block topBlock; public Block stoneBlock; public Block seaBlock; public Block bedrockBlock;
	public static final BiomeGenBase.Height height = new BiomeGenBase.Height(-1.0F, 4.0F);
	
	public BiomeSheol(int par1) {
		super(par1, true);
        this.setColor(Integer.parseInt("000000", 16));
        this.setBiomeName("Sheol");
        
        this.topBlock = YetAnotherMod.depthStone;
        this.fillerBlock = YetAnotherMod.depthStone;
        this.stoneBlock = YetAnotherMod.depthStone;
        this.seaBlock = Blocks.air;
        this.bedrockBlock = YetAnotherMod.depthStone;
