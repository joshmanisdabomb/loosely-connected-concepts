...
public class AimaggChunkGeneratorRainbow implements IChunkGenerator {
	...
	public static final IBlockState RAINBOW_STONE = AimaggBlocks.rainbowWorld.getDefaultState().withProperty(AimaggBlockRainbowWorld.TYPE, RainbowWorldType.STONE); //TODO Rainbow Stone
    ...
    private MapGenBase caveGenerator = new MapGenCaves(); //TODO custom caves and honeycomb caves
