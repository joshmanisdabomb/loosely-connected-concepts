...
public class WorldGenHotCoal extends WorldGenMinable {
    ...
    public WorldGenHotCoal(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    	super(p_i45460_1_, p_i45460_2_, Blocks.air);
        this.field_150519_a = p_i45460_1_;
        this.numberOfBlocks = p_i45460_2_;
        this.field_150518_c = p_i45460_3_;
    }

    public WorldGenHotCoal(Block block, int meta, int number)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && par1World.getBlock(k2, l2, i3).isReplaceableOreGen(par1World, k2, l2, i3, field_150518_c) && (par1World.canBlockSeeTheSky(k2, l2 + 1, i3) || par1World.getBlock(k2, l2+1, i3) == YetAnotherMod.hotCoal))
                                {
