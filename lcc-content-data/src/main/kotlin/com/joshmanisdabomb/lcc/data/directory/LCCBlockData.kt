...
object LCCBlockData : BasicDirectory<BlockDataContainer, Unit>(), ModelAccess {
    ...
    val bifrost_pedestal by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(CustomBlockAssetFactory { d, t, i -> LCCModelTemplates.template_bifrost_pedestal.upload(idb.loc(t), TextureMap().put(TextureKey.TEXTURE, LCCBlocks.bifrost.identifierLocSuffix("side")), d.models) }).add(CustomRecipeFactory { d, i ->
        ShapedRecipeJsonBuilder.create(i, 3)
            .pattern("bbb")
            .pattern(" b ")
            .pattern("bbb")
            .input('b', LCCBlocks.bifrost)
            .apply { hasCriterionShaped(this, LCCBlocks.bifrost) }
            .apply { offerShaped(this, d) }
    }).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val polished_bifrost by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultBlockAsset().defaultLootTable().mineablePickaxe().withIronTool().add(CustomRecipeFactory { d, i ->
        ShapedRecipeJsonBuilder.create(i, 4)
            .pattern("bb")
            .pattern("bb")
            .input('b', LCCBlocks.bifrost)
            .apply { hasCriterionShaped(this, LCCBlocks.bifrost) }
            .apply { offerShaped(this, d) }
    }).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost)).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val polished_bifrost_stairs by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(StairsBlockAssetFactory(LCCBlocks.polished_bifrost.identifierLoc())).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.polished_bifrost)).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("polished_bifrost_stairs_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val polished_bifrost_slab by entry(::initialiser) { data().defaultLang().defaultItemAsset().mineablePickaxe().withIronTool().add(SlabBlockAssetFactory(LCCBlocks.polished_bifrost.identifierLoc(), full = LCCBlocks.polished_bifrost.identifierLoc())).add(BlockTagFactory(BlockTags.SLABS)).add(ItemTagFactory(ItemTags.SLABS)).add(SlabRecipeFactory(LCCBlocks.polished_bifrost)).add(SlabLootFactory).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, 2)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, 2, name = LCC.id("polished_bifrost_slab_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val polished_bifrost_wall by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(WallBlockAssetFactory(LCCBlocks.polished_bifrost.identifierLoc())).add(CustomItemAssetFactory { d, t, i -> Models.WALL_INVENTORY.upload(idi.loc(t), TextureMap().put(TextureKey.WALL, LCCBlocks.polished_bifrost.identifierLoc()), d.models) }).add(BlockTagFactory(BlockTags.WALLS)).add(ItemTagFactory(ItemTags.WALLS)).add(WallRecipeFactory(LCCBlocks.polished_bifrost)).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("polished_bifrost_wall_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_bricks by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultBlockAsset().defaultLootTable().mineablePickaxe().withIronTool().add(CustomRecipeFactory { d, i ->
        ShapedRecipeJsonBuilder.create(i, 4)
            .pattern("bb")
            .pattern("bb")
            .input('b', LCCBlocks.polished_bifrost)
            .apply { hasCriterionShaped(this, LCCBlocks.polished_bifrost) }
            .apply { offerShaped(this, d) }
    }).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("bifrost_bricks_from_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost)).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_brick_stairs by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(StairsBlockAssetFactory(LCCBlocks.bifrost_bricks.identifierLoc())).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.bifrost_bricks)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_bricks)).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, name = LCC.id("bifrost_brick_stairs_from_polished_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("bifrost_brick_stairs_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_brick_slab by entry(::initialiser) { data().defaultLang().defaultItemAsset().mineablePickaxe().withIronTool().add(SlabBlockAssetFactory(LCCBlocks.bifrost_bricks.identifierLoc(), full = LCCBlocks.bifrost_bricks.identifierLoc())).add(BlockTagFactory(BlockTags.SLABS)).add(ItemTagFactory(ItemTags.SLABS)).add(SlabRecipeFactory(LCCBlocks.bifrost_bricks)).add(SlabLootFactory).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_bricks, 2)).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, 2, name = LCC.id("bifrost_brick_slab_from_polished_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, 2, name = LCC.id("bifrost_brick_slab_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_brick_wall by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(WallBlockAssetFactory(LCCBlocks.bifrost_bricks.identifierLoc())).add(CustomItemAssetFactory { d, t, i -> Models.WALL_INVENTORY.upload(idi.loc(t), TextureMap().put(TextureKey.WALL, LCCBlocks.bifrost_bricks.identifierLoc()), d.models) }).add(BlockTagFactory(BlockTags.WALLS)).add(ItemTagFactory(ItemTags.WALLS)).add(WallRecipeFactory(LCCBlocks.bifrost_bricks)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_bricks)).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, name = LCC.id("bifrost_brick_wall_from_polished_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("bifrost_brick_wall_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_tiles by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultBlockAsset().defaultLootTable().mineablePickaxe().withIronTool().add(CustomRecipeFactory { d, i ->
        ShapedRecipeJsonBuilder.create(i, 4)
            .pattern("bb")
            .pattern("bb")
            .input('b', LCCBlocks.bifrost_bricks)
            .apply { hasCriterionShaped(this, LCCBlocks.bifrost_bricks) }
            .apply { offerShaped(this, d) }
    }).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("bifrost_tiles_from_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, name = LCC.id("bifrost_tiles_from_polished_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_bricks)).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_tile_stairs by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(StairsBlockAssetFactory(LCCBlocks.bifrost_tiles.identifierLoc())).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.bifrost_tiles)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_tiles)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_bricks, name = LCC.id("bifrost_tile_stairs_from_bifrost_bricks_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, name = LCC.id("bifrost_tile_stairs_from_polished_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("bifrost_tile_stairs_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_tile_slab by entry(::initialiser) { data().defaultLang().defaultItemAsset().mineablePickaxe().withIronTool().add(SlabBlockAssetFactory(LCCBlocks.bifrost_tiles.identifierLoc(), full = LCCBlocks.bifrost_tiles.identifierLoc())).add(BlockTagFactory(BlockTags.SLABS)).add(ItemTagFactory(ItemTags.SLABS)).add(SlabRecipeFactory(LCCBlocks.bifrost_tiles)).add(SlabLootFactory).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_tiles, 2)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_bricks, 2, name = LCC.id("bifrost_tile_slab_from_bifrost_bricks_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, 2, name = LCC.id("bifrost_tile_slab_from_polished_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, 2, name = LCC.id("bifrost_tile_slab_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_tile_wall by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(WallBlockAssetFactory(LCCBlocks.bifrost_tiles.identifierLoc())).add(CustomItemAssetFactory { d, t, i -> Models.WALL_INVENTORY.upload(idi.loc(t), TextureMap().put(TextureKey.WALL, LCCBlocks.bifrost_tiles.identifierLoc()), d.models) }).add(BlockTagFactory(BlockTags.WALLS)).add(ItemTagFactory(ItemTags.WALLS)).add(WallRecipeFactory(LCCBlocks.bifrost_tiles)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_tiles)).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost_bricks, name = LCC.id("bifrost_tile_wall_from_bifrost_bricks_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost, name = LCC.id("bifrost_tile_wall_from_polished_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("bifrost_tile_wall_from_bifrost_stonecutting"))).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    val bifrost_pillar by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineablePickaxe().withIronTool().add(ColumnBlockAssetFactory(textureSide = LCCBlocks.bifrost_pillar.identifierLoc(), textureEnd = LCCBlocks.polished_bifrost.identifierLoc())).add(CustomRecipeFactory { d, i ->
        ShapedRecipeJsonBuilder.create(i, 2)
            .pattern("b")
            .pattern("b")
            .input('b', LCCBlocks.polished_bifrost)
            .apply { hasCriterionShaped(this, LCCBlocks.polished_bifrost) }
            .apply { offerShaped(this, d) }
    }).add(StonecutterItemRecipeFactory(LCCBlocks.bifrost, name = LCC.id("bifrost_pillar_from_bifrost_stonecutting"))).add(StonecutterItemRecipeFactory(LCCBlocks.polished_bifrost)).add(BlockTagFactory(LCCBlockTags.rainbow_required)) }
    ...
    val ash_log by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineableAxe().add(ColumnBlockAssetFactory(textureSide = LCCBlocks.ash_log.identifierLoc(), textureEnd = LCCBlocks.ash_log.identifierLocSuffix("top"))).add(BlockTagFactory(LCCBlockTags.ash_logs)).add(ItemTagFactory(LCCItemTags.ash_logs)).add(ItemTagFactory(LCCItemTags.ash_tree)).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_wood by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineableAxe().add(ColumnBlockAssetFactory(textureSide = LCCBlocks.ash_log.identifierLoc(), textureEnd = LCCBlocks.ash_log.identifierLoc())).add(BlockTagFactory(LCCBlockTags.ash_logs)).add(ItemTagFactory(LCCItemTags.ash_logs)).add(BarkRecipeFactory(LCCBlocks.ash_log)).add(ItemTagFactory(LCCItemTags.ash_tree)).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val stripped_ash_log by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineableAxe().add(ColumnBlockAssetFactory(textureSide = LCCBlocks.stripped_ash_log.identifierLoc(), textureEnd = LCCBlocks.stripped_ash_log.identifierLocSuffix("top"))).add(BlockTagFactory(LCCBlockTags.ash_logs)).add(ItemTagFactory(LCCItemTags.ash_logs)).add(ItemTagFactory(LCCItemTags.ash_tree)).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val stripped_ash_wood by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineableAxe().add(ColumnBlockAssetFactory(textureSide = LCCBlocks.stripped_ash_log.identifierLoc(), textureEnd = LCCBlocks.stripped_ash_log.identifierLoc())).add(BlockTagFactory(LCCBlockTags.ash_logs)).add(ItemTagFactory(LCCItemTags.ash_logs)).add(BarkRecipeFactory(LCCBlocks.stripped_ash_log)).add(ItemTagFactory(LCCItemTags.ash_tree)).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_planks by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().defaultBlockAsset().mineableAxe().add(BlockTagFactory(BlockTags.PLANKS)).add(ItemTagFactory(ItemTags.PLANKS)).add(SingleShapelessFromTagRecipeFactory(LCCItemTags.ash_logs, "has_ash_logs" to InventoryChangedCriterion.Conditions.items(ItemPredicate.Builder.create().tag(LCCItemTags.ash_logs).build()), outputCount = 4, group = "planks")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_sapling by entry(::initialiser) { data().defaultLang().defaultLootTable().add(PlantBlockAssetFactory).add(GeneratedBlockItemAssetFactory).add(BlockTagFactory(BlockTags.SAPLINGS)).add(ItemTagFactory(ItemTags.SAPLINGS)).add(ItemTagFactory(LCCItemTags.ash_tree)) }
    val potted_ash_sapling by entry(::initialiser) { data().defaultLang().add(PottedPlantBlockAssetFactory).add(PottedPlantBlockLootFactory).add(BlockTagFactory(BlockTags.FLOWER_POTS)) }
    val ash_leaves by entry(::initialiser) { data().defaultLang().defaultItemAsset().mineableHoe().add(LeavesBlockLootFactory(LCCBlocks.ash_sapling, saplingChance = floatArrayOf(0.05F, 0.0625F, 0.8333F, 0.1F))).add(BlockTagFactory(BlockTags.LEAVES)).add(TintBlockAssetFactory).add(BlockTagFactory(BlockTags.LEAVES)).add(ItemTagFactory(ItemTags.LEAVES)).add(ItemTagFactory(LCCItemTags.ash_tree)).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_stairs by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineableAxe().add(StairsBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WOODEN_STAIRS)).add(ItemTagFactory(ItemTags.WOODEN_STAIRS)).add(StairsRecipeFactory(LCCBlocks.ash_planks, group = "wooden_stairs")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_slab by entry(::initialiser) { data().defaultLang().defaultItemAsset().mineableAxe().add(SlabBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc(), full = LCCBlocks.ash_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WOODEN_SLABS)).add(ItemTagFactory(ItemTags.WOODEN_SLABS)).add(SlabRecipeFactory(LCCBlocks.ash_planks, group = "wooden_slab")).add(SlabLootFactory).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_door by entry(::initialiser) { data().defaultLang().mineableAxe().add(DoorBlockAssetFactory).add(GeneratedItemAssetFactory).add(DoorBlockLootFactory).add(BlockTagFactory(BlockTags.WOODEN_DOORS)).add(ItemTagFactory(ItemTags.WOODEN_DOORS)).add(DoorRecipeFactory(LCCBlocks.ash_planks, group = "wooden_door")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_pressure_plate by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().mineableAxe().add(PressurePlateBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WOODEN_PRESSURE_PLATES)).add(ItemTagFactory(ItemTags.WOODEN_PRESSURE_PLATES)).add(PressurePlateRecipeFactory(LCCBlocks.ash_planks, group = "wooden_pressure_plate")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_button by entry(::initialiser) { data().defaultLang().defaultLootTable().mineableAxe().add(CustomItemAssetFactory { d, t, i -> Models.BUTTON_INVENTORY.upload(i(t) ?: idi.loc(t), TextureMap.texture(LCCBlocks.ash_planks.identifierLoc()), d.models) }).add(ButtonBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WOODEN_BUTTONS)).add(ItemTagFactory(ItemTags.WOODEN_BUTTONS)).add(SingleShapelessFromItemRecipeFactory(LCCBlocks.ash_planks, group = "wooden_button")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_fence by entry(::initialiser) { data().defaultLang().defaultLootTable().mineableAxe().add(CustomItemAssetFactory { d, t, i -> Models.FENCE_INVENTORY.upload(i(t) ?: idi.loc(t), TextureMap.texture(LCCBlocks.ash_planks.identifierLoc()), d.models) }).add(FenceBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WOODEN_FENCES)).add(ItemTagFactory(ItemTags.WOODEN_FENCES)).add(FenceRecipeFactory(LCCBlocks.ash_planks, Ingredient.ofItems(Items.STICK), group = "wooden_fence")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_fence_gate by entry(::initialiser) { data().defaultLang().defaultLootTable().defaultItemAsset().mineableAxe().add(FenceGateBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc())).add(BlockTagFactory(BlockTags.FENCE_GATES)).add(FenceGateRecipeFactory(LCCBlocks.ash_planks, Ingredient.ofItems(Items.STICK), group = "wooden_fence_gate")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_trapdoor by entry(::initialiser) { data().defaultLang().defaultLootTable().defaultItemAsset().mineableAxe().add(TrapdoorBlockAssetFactory).add(BlockTagFactory(BlockTags.WOODEN_TRAPDOORS)).add(ItemTagFactory(ItemTags.WOODEN_TRAPDOORS)).add(TrapdoorRecipeFactory(LCCBlocks.ash_planks, group = "wooden_trapdoor")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_sign by entry(::initialiser) { data().defaultLang().defaultLootTable().mineableAxe().add(ParticleBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc())).add(GeneratedItemAssetFactory).add(BlockTagFactory(BlockTags.STANDING_SIGNS)).add(ItemTagFactory(ItemTags.SIGNS)).add(SignRecipeFactory(LCCBlocks.ash_planks, Ingredient.ofItems(Items.STICK), group = "wooden_sign")).add(BlockTagFactory(LCCBlockTags.rainbow_effective)) }
    val ash_wall_sign by entry(::initialiser) { data().mineableAxe().add(ParticleBlockAssetFactory(LCCBlocks.ash_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WALL_SIGNS)).add(BlockTagFactory(LCCBlockTags.wasteland_effective)) }
