...
public class AimaggPacketCapabilityPillsClient implements IMessage {
	...
	public AimaggPacketCapabilityPillsClient() {}
	...
	public static class Handler implements IMessageHandler<AimaggPacketCapabilityPillsClient, IMessage> {
        @Override
        public IMessage onMessage(final AimaggPacketCapabilityPillsClient message, final MessageContext ctx) {
        ...
        private void handle(AimaggPacketCapabilityPillsClient message, MessageContext ctx) {
