...
public class ComputingRenderer extends TileEntityRenderer<ComputingTileEntity> {
    ...
    @Override
    public void render(ComputingTileEntity te, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
