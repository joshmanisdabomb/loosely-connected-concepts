...
public class YetAnotherMod
{
    ...
    public void init(FMLInitializationEvent event)
    {
    	...
    	lightDirt = new BlockGeneric(Material.ground, "aura/light/dirt").setLightLevel(1F).setLightOpacity(255).setHardness(0.4F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightDirt");
    	...
    	lightGrass = new BlockCustomGrass("aura/light/grass/top", "aura/light/grass/side", "aura/light/dirt", YetAnotherMod.lightDirt).setLightLevel(1F).setLightOpacity(255).setHardness(0.5F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightGrass");
    	...
    	lightStone = new BlockGeneric(Material.rock, "aura/light/stone").setLightLevel(1F).setLightOpacity(255).setHardness(1.2F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightStone");
    	...
    	lightSand = new BlockGeneric(Material.ground, "aura/light/sand").setLightLevel(1F).setLightOpacity(255).setHardness(0.3F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightSand");
    	...
    	lightGravel = new BlockGeneric(Material.ground, "aura/light/gravel").setLightLevel(1F).setLightOpacity(255).setHardness(0.5F).setResistance(1.0F).setStepSound(Block.soundTypeGlass).setBlockName("lightGravel");
