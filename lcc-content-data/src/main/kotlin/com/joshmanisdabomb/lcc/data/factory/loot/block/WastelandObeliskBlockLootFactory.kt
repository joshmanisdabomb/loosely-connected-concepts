...
object WastelandObeliskBlockLootFactory : BlockDataFactory {
            ...
            LootPool.builder()
                ...
                .with(
                    ItemEntry.builder(entry)
                        ...
                        .conditionally(BlockStatePropertyLootCondition.builder(entry).properties(StatePredicate.Builder.create().exactMatch(Properties.BOTTOM, true)))
