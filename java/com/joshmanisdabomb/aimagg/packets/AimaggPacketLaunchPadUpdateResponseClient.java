...
public class AimaggPacketLaunchPadUpdateResponseClient implements IMessage {
	...
	public AimaggPacketLaunchPadUpdateResponseClient() {}
	...
	public static class Handler implements IMessageHandler<AimaggPacketLaunchPadUpdateResponseClient, IMessage> {
        @Override
        public IMessage onMessage(final AimaggPacketLaunchPadUpdateResponseClient message, final MessageContext ctx) {
        ...
        private void handle(AimaggPacketLaunchPadUpdateResponseClient message, MessageContext ctx) {
