...
public class AimaggBlockInstafall extends AimaggBlockBasic {
	
	public AimaggBlockInstafall(String internalName, int sortVal, Material material, MapColor mcolor) {
