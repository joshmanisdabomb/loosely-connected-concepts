...
public class EntityBullet extends Entity {
	...
	public EntityBullet(World par1World, EntityLivingBase par2EntityLivingBase, double par3, double par4, double par5) {
		super(par1World);
	...
	protected void onImpact(MovingObjectPosition var1) {		
		if (var1.entityHit != null) {if (shootingEntity != null) {
				var1.entityHit.attackEntityFrom(CustomDamage.causeBlasterDamage(this, shootingEntity), (float)damage);
			} else {
				var1.entityHit.attackEntityFrom(CustomDamage.blaster, (float)damage);
			}
		}

		if (this.worldObj.isRemote) {
			ParticleHandler.particleSparkClient(this.worldObj, ParticleType.BLASTER, this.posX, this.posY, this.posZ, 0.1, 50);
		} else {
            this.setDead();
        }
	}
