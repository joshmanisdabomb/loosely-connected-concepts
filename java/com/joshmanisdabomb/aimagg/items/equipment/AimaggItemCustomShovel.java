...
class AimaggItemCustomShovel extends AimaggItemCustomTool {

	public AimaggItemCustomShovel(String internalName, ToolMaterial tm, Specialization s) {
	...
	public double getAttackDamage() {
		return this.toolMaterial.getDamageVsEntity() + 1.5D;
	}
