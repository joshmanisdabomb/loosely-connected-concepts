...
object LCCBlockData : BasicDirectory<BlockDataContainer, Unit>() {
    ...
    val classic_leaves by entry(::initialiser) { BlockDataContainer().defaultLang().defaultBlockAsset().defaultItemAsset().add(LeavesBlockLootFactory(LCCBlocks.classic_sapling)).add(RiftFromTagRecipeFactory(ItemTags.LEAVES)).add(BlockTagFactory(BlockTags.LEAVES)).add(ItemTagFactory(ItemTags.LEAVES)) }
    ...
    val rubber_log by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(ColumnBlockAssetFactory(textureSide = LCC.id("block/rubber_log"), textureEnd = LCC.id("block/rubber_log_top"))).add(BlockTagFactory(LCCTags.rubber_logs)).add(ItemTagFactory(LCCTags.rubber_logs_i)) }
    val rubber_wood by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(CustomBlockAssetFactory { d, b -> modelCubeAll(d, b, texture = loc(LCC.id("rubber_log"))) }).add(BlockTagFactory(LCCTags.rubber_logs)).add(ItemTagFactory(LCCTags.rubber_logs_i)) }
    ...
    val stripped_rubber_wood by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(CustomBlockAssetFactory { d, b -> modelCubeAll(d, b, texture = loc(LCC.id("stripped_rubber_log"))) }).add(BlockTagFactory(LCCTags.rubber_logs)).add(ItemTagFactory(LCCTags.rubber_logs_i)) }
    val rubber_planks by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().defaultBlockAsset().add(BlockTagFactory(BlockTags.PLANKS)).add(ItemTagFactory(ItemTags.PLANKS)) }
    val rubber_sapling by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().add(PlantBlockAssetFactory).add(GeneratedBlockItemAssetFactory).add(BlockTagFactory(BlockTags.SAPLINGS)).add(ItemTagFactory(ItemTags.SAPLINGS)) }
    ...
    val rubber_leaves by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().add(LeavesBlockLootFactory(LCCBlocks.rubber_sapling)).add(BlockTagFactory(BlockTags.LEAVES)).add(TintBlockAssetFactory).add(BlockTagFactory(BlockTags.LEAVES)).add(ItemTagFactory(ItemTags.LEAVES)) }
    val rubber_stairs by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultItemAsset().add(StairsBlockAssetFactory(LCC.id("block/rubber_planks"))).add(BlockTagFactory(BlockTags.WOODEN_STAIRS)).add(ItemTagFactory(ItemTags.WOODEN_STAIRS)) }
    val rubber_slab by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultItemAsset().add(SlabBlockAssetFactory(LCC.id("block/rubber_planks")) { d, b -> loc(LCCBlocks.rubber_planks) }).add(BlockTagFactory(BlockTags.WOODEN_SLABS)).add(ItemTagFactory(ItemTags.WOODEN_SLABS)) }
    val rubber_door by entry(::initialiser) { BlockDataContainer().defaultLang().add(DoorBlockAssetFactory).add(GeneratedItemAssetFactory).add(DoorBlockLootFactory).add(BlockTagFactory(BlockTags.WOODEN_DOORS)).add(ItemTagFactory(ItemTags.WOODEN_DOORS)) }
    val rubber_pressure_plate by entry(::initialiser) { BlockDataContainer().defaultLang().defaultItemAsset().defaultLootTable().add(PressurePlateBlockAssetFactory(LCC.id("block/rubber_planks"))).add(BlockTagFactory(BlockTags.WOODEN_PRESSURE_PLATES)).add(ItemTagFactory(ItemTags.WOODEN_PRESSURE_PLATES)) }
    ...
    val rubber_fence by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().add(CustomItemAssetFactory { d, i -> Models.FENCE_INVENTORY.upload(loc(i), Texture.texture(loc(LCCBlocks.rubber_planks.asItem(), folder = "block")), d.modelStates::addModel) }).add(FenceBlockAssetFactory(LCC.id("block/rubber_planks"))).add(BlockTagFactory(BlockTags.WOODEN_FENCES)).add(ItemTagFactory(ItemTags.WOODEN_FENCES)) }
    val rubber_fence_gate by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().defaultItemAsset().add(FenceGateBlockAssetFactory(LCC.id("block/rubber_planks"))).add(BlockTagFactory(BlockTags.FENCE_GATES)) }
    val rubber_trapdoor by entry(::initialiser) { BlockDataContainer().defaultLang().defaultLootTable().defaultItemAsset().add(TrapdoorBlockAssetFactory).add(BlockTagFactory(BlockTags.WOODEN_TRAPDOORS)).add(ItemTagFactory(ItemTags.WOODEN_TRAPDOORS)) }
