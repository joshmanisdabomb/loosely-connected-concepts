...
public class EntityAmplifyBombFX extends EntityFX
{
    ...
    public EntityAmplifyBombFX(TextureManager par1TextureManager, World par2World, double par3, double par5, double par7, double par9, double par11, double par13)
    {
        ...
        this.particleGreen = (rand.nextFloat()*0.2F)+0.5F;
