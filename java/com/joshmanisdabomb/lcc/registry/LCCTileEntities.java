...
public abstract class LCCTileEntities {
    ...
    public static TileEntityType<?> terminal;
    ...
    public static void init(RegistryEvent.Register<TileEntityType<?>> e) {
        ...
        all.add(terminal = TileEntityType.Builder.create(TerminalTileEntity::new, LCCBlocks.terminals.values().toArray(new Block[0])).build(null).setRegistryName(LCC.MODID, "terminal"));
