...
public class RecipeData extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        this.toolset(LCCItems.vivid_sword, LCCItems.vivid_pickaxe, LCCItems.vivid_shovel, LCCItems.vivid_axe, LCCItems.vivid_hoe, LCCBlocks.vivid_planks, Tags.Items.RODS_WOODEN, LCCBlocks.vivid_planks, consumer);
        this.toolset(LCCItems.twilight_sword, LCCItems.twilight_pickaxe, LCCItems.twilight_shovel, LCCItems.twilight_axe, LCCItems.twilight_hoe, LCCBlocks.twilight_cobblestone, Tags.Items.RODS_WOODEN, LCCBlocks.twilight_cobblestone, consumer);
