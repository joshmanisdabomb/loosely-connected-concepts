...
object LCCBlockData : BasicDirectory<BlockDataContainer, Unit>(), ModelAccess {
    ...
    val cut_tungsten by entry(::initialiser) {
        data().defaultLang().defaultBlockAsset().defaultItemAsset().defaultLootTable().add(CustomRecipeFactory { d, i ->
    ...
    val cracked_mud by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().add(RotationBlockAssetFactory).add(BlockTagFactory(LCCTags.wasteland_effective)).add(BlockTagFactory(BlockTags.ENDERMAN_HOLDABLE)).add(BlockTagFactory(LCCTags.wasteland_effective)).add(SmeltFromItemRecipeFactory(LCCBlocks.mud, RecipeSerializer.SMELTING, experience = 0.1f)) }
    ...
    val soaking_soul_sand by entry(::initialiser) {
        data().defaultLang().defaultItemAsset().defaultLootTable().defaultBlockAsset().add(CustomRecipeFactory { d, i ->
    ...
    val spawner_table by entry(::initialiser) {
        data().defaultItemAsset().add(LiteralTranslationFactory("Arcane Table")).add(DungeonTableBlockAssetFactory).add(DungeonTableBlockLootFactory).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory.create(i)
                .pattern("rgp")
                .pattern("ooo")
    ...
    val classic_iron_block by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().add(SideBottomTopBlockAssetFactory).add(StorageTranslationFactory).add(TransformTranslationFactory(*LCCData.lang.getLocales().toTypedArray()) { it.replace("Block of Classic", "Classic Block of") }).add(RiftFromItemRecipeFactory(Blocks.IRON_BLOCK)) }
    val classic_gold_block by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().add(SideBottomTopBlockAssetFactory).add(StorageTranslationFactory).add(TransformTranslationFactory(*LCCData.lang.getLocales().toTypedArray()) { it.replace("Block of Classic", "Classic Block of") }).add(RiftFromItemRecipeFactory(Blocks.GOLD_BLOCK)).add(BlockTagFactory(LCCTags.nether_reactor_base)).add(ItemTagFactory(LCCTags.gold_blocks)) }
    val classic_diamond_block by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().add(SideBottomTopBlockAssetFactory).add(StorageTranslationFactory).add(TransformTranslationFactory(*LCCData.lang.getLocales().toTypedArray()) { it.replace("Block of Classic", "Classic Block of") }).add(RiftFromItemRecipeFactory(Blocks.DIAMOND_BLOCK)) }
    val alpha_iron_block by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultBlockAsset().defaultLootTable().add(StorageTranslationFactory).add(TransformTranslationFactory(*LCCData.lang.getLocales().toTypedArray()) { it.replace("Block of Alpha", "Alpha Block of") }) }
    val alpha_gold_block by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultBlockAsset().defaultLootTable().add(StorageTranslationFactory).add(TransformTranslationFactory(*LCCData.lang.getLocales().toTypedArray()) { it.replace("Block of Alpha", "Alpha Block of") }).add(BlockTagFactory(LCCTags.nether_reactor_base)).add(ItemTagFactory(LCCTags.gold_blocks)) }
    val alpha_diamond_block by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultBlockAsset().defaultLootTable().add(StorageTranslationFactory).add(TransformTranslationFactory(*LCCData.lang.getLocales().toTypedArray()) { it.replace("Block of Alpha", "Alpha Block of") }) }
    ...
    val machine_enclosure by entry(::initialiser) {
        data().defaultLang().defaultLootTable().defaultItemAsset().add(SideBottomTopBlockAssetFactory).add(CustomRecipeFactory { d, i ->
    ...
    val refiner by entry(::initialiser) {
        data().defaultLang().defaultItemAsset().defaultLootTable().add(RefiningBlockAssetFactory).add(ConcreteRefiningRecipeFactory).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 1)
                .pattern("rcr")
                .pattern("smb")
                .pattern("rpr")
    ...
    val coal_generator by entry(::initialiser) {
        data().defaultLootTable().defaultItemAsset().add(LiteralTranslationFactory("Furnace Generator", "en_us")).add(FiredGeneratorBlockAssetFactory).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 1)
                .pattern("e")
                .pattern("m")
                .pattern("f")
    ...
    val oil_generator by entry(::initialiser) {
        data().defaultLootTable().defaultItemAsset().add(LiteralTranslationFactory("Combustion Generator", "en_us")).add(FiredGeneratorBlockAssetFactory).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 1)
                .pattern("e")
                .pattern("m")
                .pattern("f")
    ...
    val turbine by entry(::initialiser) {
        data().defaultLang().defaultLootTable().add(LiteralTranslationFactory("Steam Turbine", "en_us")).add(CustomItemAssetFactory { d, t, i -> LCCModelTemplates.template_solar_panel.upload(i(t) ?: idi.loc(t), Texture().put(TextureKey.TOP, idi.loc(t, folder = "block")).put(TextureKey.SIDE, LCCBlocks.solar_panel.identifierLocSuffix("side", folder = "block")).put(TextureKey.BOTTOM, LCCBlocks.solar_panel.identifierLocSuffix("bottom", folder = "block")), d.models) }).add(TurbineBlockAssetFactory).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory.create(i)
                .pattern(" t ")
                .pattern("ici")
    ...
    val energy_bank by entry(::initialiser) {
        data().defaultLang().defaultLootTable().defaultItemAsset().add(DirectionalBlockAssetFactory(model = mb.cubeBottomTop({ LCCBlocks.machine_enclosure.identifierLoc() }, { idb.loc(it) }))).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 1)
                .pattern("bib")
                .pattern("bmb")
                .pattern("bib")
    ...
    val atomic_bomb by entry(::initialiser) {
        data().defaultLang().add(AtomicBombBlockAssetFactory).add(AtomicBombBlockLootFactory).add(CustomItemAssetFactory { d, t, i ->
    ...
    val rubber_button by entry(::initialiser) { data().defaultLang().defaultLootTable().add(CustomItemAssetFactory { d, t, i -> Models.BUTTON_INVENTORY.upload(i(t) ?: idi.loc(t), Texture.texture(LCCBlocks.rubber_planks.identifierLoc()), d.models) }).add(ButtonBlockAssetFactory(LCCBlocks.rubber_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WOODEN_BUTTONS)).add(ItemTagFactory(ItemTags.WOODEN_BUTTONS)).add(SingleShapelessFromItemRecipeFactory(LCCBlocks.rubber_planks, group = "wooden_button")) }
    val rubber_fence by entry(::initialiser) { data().defaultLang().defaultLootTable().add(CustomItemAssetFactory { d, t, i -> Models.FENCE_INVENTORY.upload(i(t) ?: idi.loc(t), Texture.texture(LCCBlocks.rubber_planks.identifierLoc()), d.models) }).add(FenceBlockAssetFactory(LCCBlocks.rubber_planks.identifierLoc())).add(BlockTagFactory(BlockTags.WOODEN_FENCES)).add(ItemTagFactory(ItemTags.WOODEN_FENCES)).add(FenceRecipeFactory(LCCBlocks.rubber_planks, Ingredient.ofItems(Items.STICK), group = "wooden_fence")) }
    ...
    val treetap by entry(::initialiser) {
        data().defaultLang().defaultItemAsset().add(TreetapBlockAssetFactory).add(CustomRecipeFactory { d, i ->
    ...
    val oxygen_extractor by entry(::initialiser) {
        data().defaultLang().defaultLootTable().defaultItemAsset().add(CustomBlockAssetFactory(mb.cubeBottomTop(textureBottom = { LCCBlocks.machine_enclosure.identifierLocSuffix("bottom") }))).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 1)
                .pattern("i i")
                .pattern("i i")
                .pattern("bmb")
    ...
    val kiln by entry(::initialiser) {
        data().defaultLang().defaultLootTable().defaultItemAsset().add(FurnaceBlockAssetFactory(textureTop = LCCBlocks.kiln.identifierLocSuffix("side"), textureBottom = LCCBlocks.kiln.identifierLocSuffix("side"))).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 1)
                .pattern("bbb")
                .pattern("bfb")
                .pattern("bbb")
    ...
    val heavy_uranium_shielding by entry(::initialiser) {
        data().defaultLang().defaultItemAsset().defaultBlockAsset().defaultLootTable().add(CustomRecipeFactory { d, i ->
            RefiningShapelessRecipeJsonFactory()
    ...
    val nuclear_generator by entry(::initialiser) {
        data().defaultLang().defaultLootTable().add(NuclearFiredGeneratorBlockAssetFactory).add(CustomItemAssetFactory { d, t, i ->
    ...
    val scattered_salt by entry(::initialiser) {
        data().defaultLang().add(SaltBlockLootFactory).add(SaltBlockAssetFactory).add(CustomItemAssetFactory { d, t, i ->
            LCCModelTemplates.template_salt_item.upload(i(t) ?: idi.loc(t), Texture.texture(LCC.block("salt")), d.models)
        })
    }
    val salt_block by entry(::initialiser) {
        data().defaultLang().defaultLootTable().defaultItemAsset().add(RotationBlockAssetFactory((0..3).toList(), (0..3).toList(), mb.cubeAll { LCC.block("salt") })).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 1)
                .pattern("sss")
                .pattern("sss")
                .pattern("sss")
    ...
    val alarm by entry(::initialiser) {
        data().defaultLang().defaultLootTable().add(CustomItemAssetFactory { d, t, i -> LCCModelTemplates.template_alarm_item.upload(i(t) ?: idi.loc(t), Texture.texture(idi.loc(t, folder = "block")), d.models) }).add(HorizontalBlockAssetFactory({ d, t, i -> LCCModelTemplates.template_alarm.upload(i(t) ?: idb.loc(t), Texture.texture(idb.loc(t)), d.models) })).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory(i, 2)
                .pattern("bib")
                .pattern("nln")
                .input('b', Blocks.BELL)
    ...
    val deposits by entry(::initialiser) { data().affects(LCCBlocks.all.values.filterIsInstance<DepositBlock>()).defaultLang().defaultItemAsset().add(DepositBlockAssetFactory).add(DepositBlockLootFactory).add(BlockTagFactory(LCCTags.wasteland_effective)) }

    val rubber_piston by entry(::initialiser) {
        data().defaultLang().defaultItemAsset().defaultLootTable().add(PistonBlockAssetFactory).add(CustomItemAssetFactory(mi.cubeBottomTop(texture = { idi.loc(it, folder = "block") }, textureBottom = { Identifier("block/piston_bottom") }))).add(CustomRecipeFactory { d, i ->
    ...
    val explosive_paste by entry(::initialiser) {
        data().defaultLang().defaultLootTable().add(GeneratedItemAssetFactory).add(WireBlockAssetFactory(
            { d, t, i -> LCCModelTemplates.template_redstone_dust_dot.upload(i(t) ?: idb.loc(t), Texture.texture(i(t) ?: idb.loc(t)).put(TextureKey.PARTICLE, idb.loc(t)).put(LCCModelTextureKeys.overlay, Identifier("block/redstone_dust_overlay")), d.models) },
            ...
            { d, t, i -> LCCModelTemplates.template_redstone_dust_up.upload(i(t) ?: idb.loc(t), Texture.texture(idb.locSuffix(t, "up")).put(TextureKey.PARTICLE, idb.loc(t)).put(LCCModelTextureKeys.overlay, Identifier("block/redstone_dust_overlay")), d.models) },
            true
        )).add(CustomRecipeFactory { d, i ->
            RefiningShapelessRecipeJsonFactory()
    ...
    val rusting_iron_blocks by entry(::initialiser) { data().affects(LCCBlocks.rusted_iron_blocks.values.toList().dropLast(1)).defaultLang().defaultLootTable().defaultItemAsset().defaultBlockAsset().add(BlockTagFactory(LCCTags.wasteland_required)) }
    val rusted_iron_block by entry(::initialiser) { data().defaultLang().defaultLootTable().defaultItemAsset().defaultBlockAsset().add(Storage9RecipeFactory(LCCItems.iron_oxide)).add(BlockTagFactory(LCCTags.wasteland_required)) }
    val rusted_iron_bars by entry(::initialiser) {
        data().defaultLang().defaultLootTable().add(GeneratedBlockItemAssetFactory).add(BarsBlockAssetFactory(
            { d, t, i -> LCCModelTemplates.template_iron_bars_post.upload(i(t) ?: idb.loc(t), Texture().put(LCCModelTextureKeys.bars, idb.loc(t)), d.models) },
            { d, t, i -> LCCModelTemplates.template_iron_bars_post_ends.upload(i(t) ?: idb.loc(t), Texture().put(TextureKey.EDGE, idb.loc(t)), d.models) },
            { d, t, i -> LCCModelTemplates.template_iron_bars_cap.upload(i(t) ?: idb.loc(t), Texture().put(LCCModelTextureKeys.bars, idb.loc(t)), d.models) },
            { d, t, i -> LCCModelTemplates.template_iron_bars_cap_alt.upload(i(t) ?: idb.loc(t), Texture().put(LCCModelTextureKeys.bars, idb.loc(t)), d.models) },
            { d, t, i -> LCCModelTemplates.template_iron_bars_side.upload(i(t) ?: idb.loc(t), Texture().put(LCCModelTextureKeys.bars, idb.loc(t)).put(TextureKey.EDGE, idb.loc(t)), d.models) },
            { d, t, i -> LCCModelTemplates.template_iron_bars_side_alt.upload(i(t) ?: idb.loc(t), Texture().put(LCCModelTextureKeys.bars, idb.loc(t)).put(TextureKey.EDGE, idb.loc(t)), d.models) }
        )).add(CustomRecipeFactory { d, i ->
    ...
    val improvised_explosive by entry(::initialiser) {
        data().defaultLang().defaultItemAsset().add(VariantBlockAssetFactory(ImprovisedExplosiveBlock.ie_state, { s ->
            mb.cube(
    ...
    val polished_fortstone by entry(::initialiser) {
        data().defaultLang().defaultLootTable().add(SpecialBlockAssetFactory).add(CustomItemAssetFactory(mi.cubeAll { idi.loc(it, folder = "block") })).add(CustomRecipeFactory { d, i ->
            ShapedRecipeJsonFactory.create(i, 4)
                .pattern("ff")
                .pattern("ff")
                ...
                .apply { offerShaped(this, d) }
        }).add(StonecutterItemRecipeFactory(LCCBlocks.fortstone)).add(BlockTagFactory(LCCTags.wasteland_required))
    }
    val fortstone_stairs by entry(::initialiser) { data().defaultLang().defaultItemAsset().defaultLootTable().add(StairsBlockAssetFactory(LCCBlocks.fortstone.identifierLoc())).add(BlockTagFactory(BlockTags.STAIRS)).add(ItemTagFactory(ItemTags.STAIRS)).add(StairsRecipeFactory(LCCBlocks.fortstone)).add(StonecutterItemRecipeFactory(LCCBlocks.fortstone)).add(BlockTagFactory(LCCTags.wasteland_required)) }
    ...
    val wasteland_obelisk by entry(::initialiser) {
        data().defaultLang().add(WastelandObeliskBlockAssetFactory).add(WastelandObeliskBlockLootFactory).add(CustomItemAssetFactory { d, t, i ->
