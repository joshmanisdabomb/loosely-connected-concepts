...
public class EntityBlasterFX extends EntityFX {

    private static final ResourceLocation texture = new ResourceLocation(YetAnotherMod.MODID, "textures/particle/blaster.png");
	private Random rand = new Random();
	private float initialParticleScale;
    
	public EntityBlasterFX(World par1World, double x, double y, double z) {
	...
	public EntityBlasterFX(World par1World, double x, double y, double z, double speedX, double speedY, double speedZ) {
    ...
    public EntityBlasterFX setMaxAge(int maxAge) {
    	particleMaxAge = maxAge;
    	return this;
    }

    public EntityBlasterFX setGravity(float gravity) {
    	particleGravity = gravity;
    	return this;
    }
    
    public EntityBlasterFX setScale(float scale) {
    	particleScale = scale;
